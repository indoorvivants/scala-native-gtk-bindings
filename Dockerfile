...
RUN apt update && apt-get install -y libgtk-4-dev libadwaita-1-dev curl && \
    ...
    curl -Lo /usr/bin/sbt https://raw.githubusercontent.com/sbt/sbt/1.10.x/sbt && chmod +x $(which sbt) 
