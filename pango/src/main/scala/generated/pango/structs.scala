...
import _root_.pango.enumerations.*
import _root_.pango.aliases.*
import _root_.pango.structs.*
 ...
 * [bindgen] header: /usr/include/pango-1.0/pango/pango-font.h
*/
opaque type PangoFontClass = CStruct9[_root_.gobject.all.GObjectClass, CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontDescription]], CFuncPtr2[Ptr[PangoFont], Ptr[PangoLanguage], Ptr[PangoCoverage]], CFuncPtr4[Ptr[PangoFont], PangoGlyph, Ptr[PangoRectangle], Ptr[PangoRectangle], Unit], CFuncPtr2[Ptr[PangoFont], Ptr[PangoLanguage], Ptr[PangoFontMetrics]], CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontMap]], CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontDescription]], CFuncPtr4[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_feature_t], _root_.glib.all.guint, Ptr[_root_.glib.all.guint], Unit], CFuncPtr1[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_font_t]]]
object PangoFontClass:
  ...
  extension (struct: PangoFontClass)
    ...
    def get_features : CFuncPtr4[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_feature_t], _root_.glib.all.guint, Ptr[_root_.glib.all.guint], Unit] = struct._8
    def get_features_=(value: CFuncPtr4[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_feature_t], _root_.glib.all.guint, Ptr[_root_.glib.all.guint], Unit]): Unit = !struct.at8 = value
    def create_hb_font : CFuncPtr1[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_font_t]] = struct._9
    def create_hb_font_=(value: CFuncPtr1[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_font_t]]): Unit = !struct.at9 = value
...
object _PangoFontClass:
  ...
  def apply(parent_class : _root_.gobject.all.GObjectClass, describe : CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontDescription]], get_coverage : CFuncPtr2[Ptr[PangoFont], Ptr[PangoLanguage], Ptr[PangoCoverage]], get_glyph_extents : CFuncPtr4[Ptr[PangoFont], PangoGlyph, Ptr[PangoRectangle], Ptr[PangoRectangle], Unit], get_metrics : CFuncPtr2[Ptr[PangoFont], Ptr[PangoLanguage], Ptr[PangoFontMetrics]], get_font_map : CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontMap]], describe_absolute : CFuncPtr1[Ptr[PangoFont], Ptr[PangoFontDescription]], get_features : CFuncPtr4[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_feature_t], _root_.glib.all.guint, Ptr[_root_.glib.all.guint], Unit], create_hb_font : CFuncPtr1[Ptr[PangoFont], Ptr[_root_.harfbuzz.all.hb_font_t]])(using Zone): Ptr[_PangoFontClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).describe = describe
    (!____ptr).get_coverage = get_coverage
