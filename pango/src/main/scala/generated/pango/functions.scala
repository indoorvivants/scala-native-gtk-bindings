...
@extern
private[pango] object extern_functions:
  /**
  ...
  */
   ...
   * [bindgen] header: /usr/include/pango-1.0/pango/pango-font.h
  */
  def pango_font_get_features(font : Ptr[PangoFont], features : Ptr[_root_.harfbuzz.all.hb_feature_t], len : _root_.glib.all.guint, num_features : Ptr[_root_.glib.all.guint]): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/pango-1.0/pango/pango-font.h
  */
  def pango_font_get_hb_font(font : Ptr[PangoFont]): Ptr[_root_.harfbuzz.all.hb_font_t] = extern
