...
object GdkTimeCoord:
  given _tag: Tag[GdkTimeCoord] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.guint32, GdkAxisFlags, CArray[Double, Nat.Digit2[Nat._1, Nat._2]]]
  def apply()(using Zone): Ptr[GdkTimeCoord] = scala.scalanative.unsafe.alloc[GdkTimeCoord](1)
  def apply(time : _root_.sn.gnome.glib.internal.guint32, flags : GdkAxisFlags, axes : CArray[Double, Nat.Digit2[Nat._1, Nat._2]])(using Zone): Ptr[GdkTimeCoord] = 
    val ____ptr = apply()
    (!____ptr).time = time
    (!____ptr).flags = flags
    (!____ptr).axes = axes
  ...
  extension (struct: GdkTimeCoord)
    def time : _root_.sn.gnome.glib.internal.guint32 = struct._1
    def time_=(value: _root_.sn.gnome.glib.internal.guint32): Unit = !struct.at1 = value
...
object GtkAccessibleTextInterface:
  ...
  extension (struct: GtkAccessibleTextInterface)
    ...
    def get_attributes : CFuncPtr6[Ptr[GtkAccessibleText], CUnsignedInt, Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[Ptr[GtkAccessibleTextRange]], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], _root_.sn.gnome.glib.internal.gboolean] = struct._6
    def get_attributes_=(value: CFuncPtr6[Ptr[GtkAccessibleText], CUnsignedInt, Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[Ptr[GtkAccessibleTextRange]], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at6 = value
    def get_default_attributes : CFuncPtr3[Ptr[GtkAccessibleText], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], Unit] = struct._7
    def get_default_attributes_=(value: CFuncPtr3[Ptr[GtkAccessibleText], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], Unit]): Unit = !struct.at7 = value
...
opaque type GtkActionableInterface = CStruct5[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]], CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]], CFuncPtr2[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant], Unit]]
object GtkActionableInterface:
  given _tag: Tag[GtkActionableInterface] = Tag.materializeCStruct5Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]], CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]], CFuncPtr2[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant], Unit]]
  def apply()(using Zone): Ptr[GtkActionableInterface] = scala.scalanative.unsafe.alloc[GtkActionableInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_action_name : CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]], set_action_name : CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit], get_action_target_value : CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]], set_action_target_value : CFuncPtr2[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant], Unit])(using Zone): Ptr[GtkActionableInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
  ...
  extension (struct: GtkActionableInterface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def get_action_name : CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]] = struct._2
    def get_action_name_=(value: CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]]): Unit = !struct.at2 = value
    def set_action_name : CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit] = struct._3
    def set_action_name_=(value: CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit]): Unit = !struct.at3 = value
    def get_action_target_value : CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]] = struct._4
    def get_action_target_value_=(value: CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]]): Unit = !struct.at4 = value
...
object GtkAdjustmentClass:
  ...
  extension (struct: GtkAdjustmentClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass): Unit = !struct.at1 = value
...
object GtkApplication:
  ...
  def apply(parent_instance : _root_.sn.gnome.gio.internal.GApplication)(using Zone): Ptr[GtkApplication] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
  extension (struct: GtkApplication)
    def parent_instance : _root_.sn.gnome.gio.internal.GApplication = struct._1
    def parent_instance_=(value: _root_.sn.gnome.gio.internal.GApplication): Unit = !struct.at1 = value
...
*/
opaque type GtkApplicationClass = CStruct4[_root_.sn.gnome.gio.internal.GApplicationClass, CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkApplicationClass:
  given _tag: Tag[GtkApplicationClass] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gio.internal.GApplicationClass, CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkApplicationClass] = scala.scalanative.unsafe.alloc[GtkApplicationClass](1)
  def apply(parent_class : _root_.sn.gnome.gio.internal.GApplicationClass, window_added : CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], window_removed : CFuncPtr2[Ptr[GtkApplication], Ptr[GtkWindow], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkApplicationClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkApplicationClass)
    def parent_class : _root_.sn.gnome.gio.internal.GApplicationClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gio.internal.GApplicationClass): Unit = !struct.at1 = value
...
*/
opaque type GtkApplicationWindowClass = CStruct2[GtkWindowClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkApplicationWindowClass:
  given _tag: Tag[GtkApplicationWindowClass] = Tag.materializeCStruct2Tag[GtkWindowClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkApplicationWindowClass] = scala.scalanative.unsafe.alloc[GtkApplicationWindowClass](1)
  def apply(parent_class : GtkWindowClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkApplicationWindowClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkBitsetIter:
  ...
  def apply(private_data : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]])(using Zone): Ptr[GtkBitsetIter] = 
    val ____ptr = apply()
...
*/
opaque type GtkBorder = CStruct4[_root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16]
object GtkBorder:
  given _tag: Tag[GtkBorder] = Tag.materializeCStruct4Tag[_root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16, _root_.sn.gnome.glib.internal.gint16]
  def apply()(using Zone): Ptr[GtkBorder] = scala.scalanative.unsafe.alloc[GtkBorder](1)
  def apply(left : _root_.sn.gnome.glib.internal.gint16, right : _root_.sn.gnome.glib.internal.gint16, top : _root_.sn.gnome.glib.internal.gint16, bottom : _root_.sn.gnome.glib.internal.gint16)(using Zone): Ptr[GtkBorder] = 
    val ____ptr = apply()
    (!____ptr).left = left
    (!____ptr).right = right
    (!____ptr).top = top
  ...
  extension (struct: GtkBorder)
    def left : _root_.sn.gnome.glib.internal.gint16 = struct._1
    def left_=(value: _root_.sn.gnome.glib.internal.gint16): Unit = !struct.at1 = value
    def right : _root_.sn.gnome.glib.internal.gint16 = struct._2
    def right_=(value: _root_.sn.gnome.glib.internal.gint16): Unit = !struct.at2 = value
    def top : _root_.sn.gnome.glib.internal.gint16 = struct._3
    def top_=(value: _root_.sn.gnome.glib.internal.gint16): Unit = !struct.at3 = value
...
*/
opaque type GtkBoxClass = CStruct2[GtkWidgetClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkBoxClass:
  given _tag: Tag[GtkBoxClass] = Tag.materializeCStruct2Tag[GtkWidgetClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkBoxClass] = scala.scalanative.unsafe.alloc[GtkBoxClass](1)
  def apply(parent_class : GtkWidgetClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkBoxClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
*/
opaque type GtkBuildableIface = CStruct11[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]]
object GtkBuildableIface:
  given _tag: Tag[GtkBuildableIface] = Tag.materializeCStruct11Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]]
  def apply()(using Zone): Ptr[GtkBuildableIface] = scala.scalanative.unsafe.alloc[GtkBuildableIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, set_id : CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], get_id : CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], add_child : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], set_buildable_property : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], construct_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], custom_tag_start : CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], custom_tag_end : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], custom_finished : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], parser_finished : CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], get_internal_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]])(using Zone): Ptr[GtkBuildableIface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
  ...
  extension (struct: GtkBuildableIface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def set_id : CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit] = struct._2
    def set_id_=(value: CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit]): Unit = !struct.at2 = value
    def get_id : CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]] = struct._3
    def get_id_=(value: CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]]): Unit = !struct.at3 = value
    def add_child : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit] = struct._4
    def add_child_=(value: CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit]): Unit = !struct.at4 = value
    def set_buildable_property : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit] = struct._5
    def set_buildable_property_=(value: CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit]): Unit = !struct.at5 = value
    def construct_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]] = struct._6
    def construct_child_=(value: CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]): Unit = !struct.at6 = value
    def custom_tag_start : CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean] = struct._7
    def custom_tag_start_=(value: CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at7 = value
    def custom_tag_end : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._8
    def custom_tag_end_=(value: CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = !struct.at8 = value
    def custom_finished : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._9
    def custom_finished_=(value: CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = !struct.at9 = value
    ...
    def get_internal_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]] = struct._11
    def get_internal_child_=(value: CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]): Unit = !struct.at11 = value
...
*/
opaque type GtkBuildableParser = CStruct5[CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._4]]
object GtkBuildableParser:
  given _tag: Tag[GtkBuildableParser] = Tag.materializeCStruct5Tag[CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._4]]
  def apply()(using Zone): Ptr[GtkBuildableParser] = scala.scalanative.unsafe.alloc[GtkBuildableParser](1)
  def apply(start_element : CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], end_element : CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], text : CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], error : CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._4])(using Zone): Ptr[GtkBuildableParser] = 
    val ____ptr = apply()
  ...
  extension (struct: GtkBuildableParser)
    def start_element : CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit] = struct._1
    def start_element_=(value: CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit]): Unit = !struct.at1 = value
    def end_element : CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit] = struct._2
    def end_element_=(value: CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit]): Unit = !struct.at2 = value
    def text : CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit] = struct._3
    def text_=(value: CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit]): Unit = !struct.at3 = value
    def error : CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._4
    def error_=(value: CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = !struct.at4 = value
...
object GtkBuilderCScope:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkBuilderCScope] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkBuilderCScopeClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkBuilderCScopeClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
*/
opaque type GtkBuilderScopeInterface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[Byte]]]
object GtkBuilderScopeInterface:
  given _tag: Tag[GtkBuilderScopeInterface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[Byte]]]
  def apply()(using Zone): Ptr[GtkBuilderScopeInterface] = scala.scalanative.unsafe.alloc[GtkBuilderScopeInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_type_from_name : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], get_type_from_function : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], create_closure : CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[_root_.sn.gnome.gobject.internal.GClosure]])(using Zone): Ptr[GtkBuilderScopeInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
  ...
  extension (struct: GtkBuilderScopeInterface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def get_type_from_name : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType] = struct._2
    def get_type_from_name_=(value: CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType]): Unit = !struct.at2 = value
    def get_type_from_function : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType] = struct._3
    def get_type_from_function_=(value: CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType]): Unit = !struct.at3 = value
    def create_closure : CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[_root_.sn.gnome.gobject.internal.GClosure]] = struct._4.asInstanceOf[CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[_root_.sn.gnome.gobject.internal.GClosure]]]
    def create_closure_=(value: CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[_root_.sn.gnome.gobject.internal.GClosure]]): Unit = !struct.at4 = value.asInstanceOf[CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[Byte]]]
...
*/
opaque type GtkCellAreaClass = CStruct21[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkCellAreaClass:
  given _tag: Tag[GtkCellAreaClass] = Tag.materializeCStruct21Tag[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkCellAreaClass] = scala.scalanative.unsafe.alloc[GtkCellAreaClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, add : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], remove : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], foreach : CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], foreach_alloc : CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], event : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], snapshot : CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], apply_attributes : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], create_context : CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], copy_context : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], get_request_mode : CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], get_preferred_width : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_height_for_width : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_preferred_height : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_width_for_height : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], set_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], get_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], focus : CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], is_activatable : CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], activate : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkCellAreaClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).add = add
  ...
  extension (struct: GtkCellAreaClass)
    ...
    def foreach : CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._4
    def foreach_=(value: CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = !struct.at4 = value
    def foreach_alloc : CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit] = struct._5
    def foreach_alloc_=(value: CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit]): Unit = !struct.at5 = value
    ...
    def snapshot : CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit] = struct._7
    def snapshot_=(value: CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit]): Unit = !struct.at7 = value
    def apply_attributes : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit] = struct._8
    def apply_attributes_=(value: CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit]): Unit = !struct.at8 = value
    ...
    def set_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit] = struct._16
    def set_cell_property_=(value: CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit]): Unit = !struct.at16 = value
    def get_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit] = struct._17
    def get_cell_property_=(value: CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit]): Unit = !struct.at17 = value
    def focus : CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean] = struct._18
    def focus_=(value: CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at18 = value
    def is_activatable : CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean] = struct._19
    def is_activatable_=(value: CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at19 = value
    def activate : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._20
    def activate_=(value: CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at20 = value
...
object GtkCellAreaContext:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkCellAreaContext] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
*/
opaque type GtkCellEditableIface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr2[Ptr[GtkCellEditable], Ptr[GdkEvent], Unit]]
object GtkCellEditableIface:
  given _tag: Tag[GtkCellEditableIface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr1[Ptr[GtkCellEditable], Unit], CFuncPtr2[Ptr[GtkCellEditable], Ptr[GdkEvent], Unit]]
  def apply()(using Zone): Ptr[GtkCellEditableIface] = scala.scalanative.unsafe.alloc[GtkCellEditableIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, editing_done : CFuncPtr1[Ptr[GtkCellEditable], Unit], remove_widget : CFuncPtr1[Ptr[GtkCellEditable], Unit], start_editing : CFuncPtr2[Ptr[GtkCellEditable], Ptr[GdkEvent], Unit])(using Zone): Ptr[GtkCellEditableIface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
...
*/
opaque type GtkCellLayoutIface = CStruct10[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellLayout], Unit], CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], CInt, Unit], CFuncPtr1[Ptr[GtkCellLayout], Ptr[Byte]], CFuncPtr1[Ptr[GtkCellLayout], Ptr[GtkCellArea]]]
object GtkCellLayoutIface:
  given _tag: Tag[GtkCellLayoutIface] = Tag.materializeCStruct10Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellLayout], Unit], CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], CInt, Unit], CFuncPtr1[Ptr[GtkCellLayout], Ptr[Byte]], CFuncPtr1[Ptr[GtkCellLayout], Ptr[GtkCellArea]]]
  def apply()(using Zone): Ptr[GtkCellLayoutIface] = scala.scalanative.unsafe.alloc[GtkCellLayoutIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, pack_start : CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], pack_end : CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], clear : CFuncPtr1[Ptr[GtkCellLayout], Unit], add_attribute : CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit], set_cell_data_func : CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], clear_attributes : CFuncPtr2[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Unit], reorder : CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], CInt, Unit], get_cells : CFuncPtr1[Ptr[GtkCellLayout], Ptr[_root_.sn.gnome.glib.internal.GList]], get_area : CFuncPtr1[Ptr[GtkCellLayout], Ptr[GtkCellArea]])(using Zone): Ptr[GtkCellLayoutIface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
  ...
  extension (struct: GtkCellLayoutIface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def pack_start : CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit] = struct._2
    def pack_start_=(value: CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit]): Unit = !struct.at2 = value
    def pack_end : CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit] = struct._3
    def pack_end_=(value: CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit]): Unit = !struct.at3 = value
    ...
    def add_attribute : CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit] = struct._5
    def add_attribute_=(value: CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit]): Unit = !struct.at5 = value
    def set_cell_data_func : CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit] = struct._6
    def set_cell_data_func_=(value: CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit]): Unit = !struct.at6 = value
    ...
    def get_cells : CFuncPtr1[Ptr[GtkCellLayout], Ptr[_root_.sn.gnome.glib.internal.GList]] = struct._9.asInstanceOf[CFuncPtr1[Ptr[GtkCellLayout], Ptr[_root_.sn.gnome.glib.internal.GList]]]
    def get_cells_=(value: CFuncPtr1[Ptr[GtkCellLayout], Ptr[_root_.sn.gnome.glib.internal.GList]]): Unit = !struct.at9 = value.asInstanceOf[CFuncPtr1[Ptr[GtkCellLayout], Ptr[Byte]]]
...
*/
opaque type GtkCellRendererClass = CStruct13[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], CFuncPtr1[Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkCellRendererClass:
  given _tag: Tag[GtkCellRendererClass] = Tag.materializeCStruct13Tag[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], CFuncPtr1[Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkCellRendererClass] = scala.scalanative.unsafe.alloc[GtkCellRendererClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, get_request_mode : CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], get_preferred_width : CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_height_for_width : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_preferred_height : CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_width_for_height : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_aligned_area : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], snapshot : CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], activate : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], start_editing : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], editing_canceled : CFuncPtr1[Ptr[GtkCellRenderer], Unit], editing_started : CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkCellRendererClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).get_request_mode = get_request_mode
    (!____ptr).get_preferred_width = get_preferred_width
  ...
  extension (struct: GtkCellRendererClass)
    ...
    def activate : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean] = struct._9
    def activate_=(value: CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at9 = value
    def start_editing : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]] = struct._10
    def start_editing_=(value: CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]]): Unit = !struct.at10 = value
    ...
    def editing_started : CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit] = struct._12
    def editing_started_=(value: CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit]): Unit = !struct.at12 = value
...
opaque type GtkCellRendererTextClass = CStruct3[GtkCellRendererClass, CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkCellRendererTextClass:
  given _tag: Tag[GtkCellRendererTextClass] = Tag.materializeCStruct3Tag[GtkCellRendererClass, CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkCellRendererTextClass] = scala.scalanative.unsafe.alloc[GtkCellRendererTextClass](1)
  def apply(parent_class : GtkCellRendererClass, edited : CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkCellRendererTextClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkCellRendererTextClass)
    ...
    def edited : CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit] = struct._2
    def edited_=(value: CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit]): Unit = !struct.at2 = value
...
object GtkColorChooserInterface:
  ...
  extension (struct: GtkColorChooserInterface)
    def base_interface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def base_interface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
...
*/
opaque type GtkComboBoxClass = CStruct5[GtkWidgetClass, CFuncPtr1[Ptr[GtkComboBox], Unit], CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkComboBox], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7]]
object GtkComboBoxClass:
  given _tag: Tag[GtkComboBoxClass] = Tag.materializeCStruct5Tag[GtkWidgetClass, CFuncPtr1[Ptr[GtkComboBox], Unit], CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkComboBox], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7]]
  def apply()(using Zone): Ptr[GtkComboBoxClass] = scala.scalanative.unsafe.alloc[GtkComboBoxClass](1)
  def apply(parent_class : GtkWidgetClass, changed : CFuncPtr1[Ptr[GtkComboBox], Unit], format_entry_text : CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], activate : CFuncPtr1[Ptr[GtkComboBox], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7])(using Zone): Ptr[GtkComboBoxClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).changed = changed
  ...
  extension (struct: GtkComboBoxClass)
    ...
    def format_entry_text : CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]] = struct._3
    def format_entry_text_=(value: CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]]): Unit = !struct.at3 = value
...
object GtkConstraintGuideClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkConstraintGuideClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkCssLocation:
  ...
  def apply(bytes : _root_.sn.gnome.glib.internal.gsize, chars : _root_.sn.gnome.glib.internal.gsize, lines : _root_.sn.gnome.glib.internal.gsize, line_bytes : _root_.sn.gnome.glib.internal.gsize, line_chars : _root_.sn.gnome.glib.internal.gsize)(using Zone): Ptr[GtkCssLocation] = 
    val ____ptr = apply()
    (!____ptr).bytes = bytes
    (!____ptr).chars = chars
    (!____ptr).lines = lines
  ...
  extension (struct: GtkCssLocation)
    def bytes : _root_.sn.gnome.glib.internal.gsize = struct._1
    def bytes_=(value: _root_.sn.gnome.glib.internal.gsize): Unit = !struct.at1 = value
    def chars : _root_.sn.gnome.glib.internal.gsize = struct._2
    def chars_=(value: _root_.sn.gnome.glib.internal.gsize): Unit = !struct.at2 = value
    def lines : _root_.sn.gnome.glib.internal.gsize = struct._3
    def lines_=(value: _root_.sn.gnome.glib.internal.gsize): Unit = !struct.at3 = value
    def line_bytes : _root_.sn.gnome.glib.internal.gsize = struct._4
    def line_bytes_=(value: _root_.sn.gnome.glib.internal.gsize): Unit = !struct.at4 = value
...
object GtkDirectoryListClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkDirectoryListClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkDrawingAreaClass:
  ...
  def apply(parent_class : GtkWidgetClass, resize : CFuncPtr3[Ptr[GtkDrawingArea], CInt, CInt, Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkDrawingAreaClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
...
opaque type GtkEditableInterface = CStruct10[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[GtkEditable]]]
object GtkEditableInterface:
  given _tag: Tag[GtkEditableInterface] = Tag.materializeCStruct10Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[GtkEditable]]]
  def apply()(using Zone): Ptr[GtkEditableInterface] = scala.scalanative.unsafe.alloc[GtkEditableInterface](1)
  def apply(base_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], delete_text : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], changed : CFuncPtr1[Ptr[GtkEditable], Unit], get_text : CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]], do_insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], do_delete_text : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], get_selection_bounds : CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], set_selection_bounds : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], get_delegate : CFuncPtr1[Ptr[GtkEditable], Ptr[GtkEditable]])(using Zone): Ptr[GtkEditableInterface] = 
    val ____ptr = apply()
  ...
  extension (struct: GtkEditableInterface)
    ...
    def insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit] = struct._2
    def insert_text_=(value: CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit]): Unit = !struct.at2 = value
    ...
    def get_text : CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]] = struct._5
    def get_text_=(value: CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]]): Unit = !struct.at5 = value
    def do_insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit] = struct._6
    def do_insert_text_=(value: CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit]): Unit = !struct.at6 = value
    ...
    def get_selection_bounds : CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean] = struct._8
    def get_selection_bounds_=(value: CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at8 = value
...
object GtkEntryBuffer:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkEntryBuffer] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
opaque type GtkEntryBufferClass = CStruct15[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object GtkEntryBufferClass:
  given _tag: Tag[GtkEntryBufferClass] = Tag.materializeCStruct15Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[GtkEntryBufferClass] = scala.scalanative.unsafe.alloc[GtkEntryBufferClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, inserted_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], deleted_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], get_text : CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], get_length : CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], insert_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], delete_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit], _gtk_reserved5 : CFuncPtr0[Unit], _gtk_reserved6 : CFuncPtr0[Unit], _gtk_reserved7 : CFuncPtr0[Unit], _gtk_reserved8 : CFuncPtr0[Unit])(using Zone): Ptr[GtkEntryBufferClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkEntryBufferClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def inserted_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit] = struct._2
    def inserted_text_=(value: CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit]): Unit = !struct.at2 = value
    def deleted_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit] = struct._3
    def deleted_text_=(value: CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit]): Unit = !struct.at3 = value
    def get_text : CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]] = struct._4
    def get_text_=(value: CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]]): Unit = !struct.at4 = value
    def get_length : CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint] = struct._5
    def get_length_=(value: CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint]): Unit = !struct.at5 = value
    def insert_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint] = struct._6
    def insert_text_=(value: CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]): Unit = !struct.at6 = value
    def delete_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint] = struct._7
    def delete_text_=(value: CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint]): Unit = !struct.at7 = value
...
object GtkFilter:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkFilter] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkFilterClass:
  ...
  extension (struct: GtkFilterClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def `match` : CFuncPtr2[Ptr[GtkFilter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def match_=(value: CFuncPtr2[Ptr[GtkFilter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
...
object GtkFilterListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkFilterListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkFixedClass:
  ...
  def apply(parent_class : GtkWidgetClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkFixedClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkFlattenListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkFlattenListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkFlowBoxChildClass:
  ...
  def apply(parent_class : GtkWidgetClass, activate : CFuncPtr1[Ptr[GtkFlowBoxChild], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkFlowBoxChildClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).activate = activate
    (!____ptr).padding = padding
...
opaque type GtkFontChooserIface = CStruct9[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFamily]], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFace]], CFuncPtr1[Ptr[GtkFontChooser], CInt], CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap], Unit], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]]]
object GtkFontChooserIface:
  given _tag: Tag[GtkFontChooserIface] = Tag.materializeCStruct9Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFamily]], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFace]], CFuncPtr1[Ptr[GtkFontChooser], CInt], CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap], Unit], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]]]
  def apply()(using Zone): Ptr[GtkFontChooserIface] = scala.scalanative.unsafe.alloc[GtkFontChooserIface](1)
  def apply(base_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_font_family : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFamily]], get_font_face : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFace]], get_font_size : CFuncPtr1[Ptr[GtkFontChooser], CInt], set_filter_func : CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], font_activated : CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit], set_font_map : CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap], Unit], get_font_map : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap]], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]])(using Zone): Ptr[GtkFontChooserIface] = 
    val ____ptr = apply()
    (!____ptr).base_iface = base_iface
  ...
  extension (struct: GtkFontChooserIface)
    ...
    def font_activated : CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit] = struct._6
    def font_activated_=(value: CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit]): Unit = !struct.at6 = value
...
*/
opaque type GtkFrameClass = CStruct3[GtkWidgetClass, CFuncPtr2[Ptr[GtkFrame], Ptr[GtkAllocation], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkFrameClass:
  given _tag: Tag[GtkFrameClass] = Tag.materializeCStruct3Tag[GtkWidgetClass, CFuncPtr2[Ptr[GtkFrame], Ptr[GtkAllocation], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkFrameClass] = scala.scalanative.unsafe.alloc[GtkFrameClass](1)
  def apply(parent_class : GtkWidgetClass, compute_child_allocation : CFuncPtr2[Ptr[GtkFrame], Ptr[GtkAllocation], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkFrameClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
...
object GtkGLAreaClass:
  ...
  extension (struct: GtkGLAreaClass)
    def parent_class : GtkWidgetClass = struct._1
    def parent_class_=(value: GtkWidgetClass): Unit = !struct.at1 = value
    def render : CFuncPtr2[Ptr[GtkGLArea], Ptr[GdkGLContext], _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def render_=(value: CFuncPtr2[Ptr[GtkGLArea], Ptr[GdkGLContext], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
...
*/
opaque type GtkGridClass = CStruct2[GtkWidgetClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkGridClass:
  given _tag: Tag[GtkGridClass] = Tag.materializeCStruct2Tag[GtkWidgetClass, CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkGridClass] = scala.scalanative.unsafe.alloc[GtkGridClass](1)
  def apply(parent_class : GtkWidgetClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkGridClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkIMContext:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkIMContext] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkIMContextClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, preedit_start : CFuncPtr1[Ptr[GtkIMContext], Unit], preedit_end : CFuncPtr1[Ptr[GtkIMContext], Unit], preedit_changed : CFuncPtr1[Ptr[GtkIMContext], Unit], commit : CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit], retrieve_surrounding : CFuncPtr1[Ptr[GtkIMContext], _root_.sn.gnome.glib.internal.gboolean], delete_surrounding : CFuncPtr3[Ptr[GtkIMContext], CInt, CInt, _root_.sn.gnome.glib.internal.gboolean], set_client_widget : CFuncPtr2[Ptr[GtkIMContext], Ptr[GtkWidget], Unit], get_preedit_string : CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit], filter_keypress : CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean], focus_in : CFuncPtr1[Ptr[GtkIMContext], Unit], focus_out : CFuncPtr1[Ptr[GtkIMContext], Unit], reset : CFuncPtr1[Ptr[GtkIMContext], Unit], set_cursor_location : CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkRectangle], Unit], set_use_preedit : CFuncPtr2[Ptr[GtkIMContext], _root_.sn.gnome.glib.internal.gboolean, Unit], set_surrounding : CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit], get_surrounding : CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], set_surrounding_with_selection : CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit], get_surrounding_with_selection : CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], activate_osk : CFuncPtr1[Ptr[GtkIMContext], Unit], activate_osk_with_event : CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkIMContextClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkIMContextClass)
    ...
    def commit: CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit] = !struct.at(offsets(4)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit]]]
    def commit_=(value: CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit]): Unit = !struct.at(offsets(4)).asInstanceOf[Ptr[CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit]]] = value
    ...
    def get_preedit_string: CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit] = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit]]]
    def get_preedit_string_=(value: CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit]): Unit = !struct.at(offsets(8)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit]]] = value
    ...
    def set_surrounding: CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit] = !struct.at(offsets(15)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit]]]
    def set_surrounding_=(value: CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit]): Unit = !struct.at(offsets(15)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit]]] = value
    def get_surrounding: CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean] = !struct.at(offsets(16)).asInstanceOf[Ptr[CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]]]
    def get_surrounding_=(value: CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at(offsets(16)).asInstanceOf[Ptr[CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]]] = value
    def set_surrounding_with_selection: CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit] = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit]]]
    def set_surrounding_with_selection_=(value: CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit]): Unit = !struct.at(offsets(17)).asInstanceOf[Ptr[CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit]]] = value
    def get_surrounding_with_selection: CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean] = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]]]
    def get_surrounding_with_selection_=(value: CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at(offsets(18)).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]]] = value
  ...
  val offsets: Array[Int] = 
    ...
    res(4) = align(res(3) + sizeof[CFuncPtr1[Ptr[GtkIMContext], Unit]].toInt, alignmentof[CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit]].toInt)
    res(5) = align(res(4) + sizeof[CFuncPtr2[Ptr[GtkIMContext], Ptr[CUnsignedChar], Unit]].toInt, alignmentof[CFuncPtr1[Ptr[GtkIMContext], _root_.sn.gnome.glib.internal.gboolean]].toInt)
    ...
    res(8) = align(res(7) + sizeof[CFuncPtr2[Ptr[GtkIMContext], Ptr[GtkWidget], Unit]].toInt, alignmentof[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit]].toInt)
    res(9) = align(res(8) + sizeof[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[_root_.sn.gnome.pango.internal.PangoAttrList]], Ptr[CInt], Unit]].toInt, alignmentof[CFuncPtr2[Ptr[GtkIMContext], Ptr[GdkEvent], _root_.sn.gnome.glib.internal.gboolean]].toInt)
    ...
    res(15) = align(res(14) + sizeof[CFuncPtr2[Ptr[GtkIMContext], _root_.sn.gnome.glib.internal.gboolean, Unit]].toInt, alignmentof[CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit]].toInt)
    res(16) = align(res(15) + sizeof[CFuncPtr4[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, Unit]].toInt, alignmentof[CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]].toInt)
    res(17) = align(res(16) + sizeof[CFuncPtr3[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]].toInt, alignmentof[CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit]].toInt)
    res(18) = align(res(17) + sizeof[CFuncPtr5[Ptr[GtkIMContext], Ptr[CUnsignedChar], CInt, CInt, CInt, Unit]].toInt, alignmentof[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]].toInt)
    res(19) = align(res(18) + sizeof[CFuncPtr4[Ptr[GtkIMContext], Ptr[Ptr[CUnsignedChar]], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean]].toInt, alignmentof[CFuncPtr1[Ptr[GtkIMContext], Unit]].toInt)
...
object GtkLayoutChild:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkLayoutChild] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkLayoutChildClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkLayoutChildClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkLayoutManager:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkLayoutManager] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkLayoutManagerClass:
  ...
  extension (struct: GtkLayoutManagerClass)
    ...
    def layout_child_type : _root_.sn.gnome.gobject.internal.GType = struct._5
    def layout_child_type_=(value: _root_.sn.gnome.gobject.internal.GType): Unit = !struct.at5 = value
...
*/
opaque type GtkListBoxRowClass = CStruct3[GtkWidgetClass, CFuncPtr1[Ptr[GtkListBoxRow], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkListBoxRowClass:
  given _tag: Tag[GtkListBoxRowClass] = Tag.materializeCStruct3Tag[GtkWidgetClass, CFuncPtr1[Ptr[GtkListBoxRow], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkListBoxRowClass] = scala.scalanative.unsafe.alloc[GtkListBoxRowClass](1)
  def apply(parent_class : GtkWidgetClass, activate : CFuncPtr1[Ptr[GtkListBoxRow], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkListBoxRowClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).activate = activate
    (!____ptr).padding = padding
...
object GtkListStoreClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkListStoreClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkMapListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkMapListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkMediaStream:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkMediaStream] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkMediaStreamClass:
  ...
  extension (struct: GtkMediaStreamClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def play : CFuncPtr1[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def play_=(value: CFuncPtr1[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
    ...
    def seek : CFuncPtr2[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gint64, Unit] = struct._4
    def seek_=(value: CFuncPtr2[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gint64, Unit]): Unit = !struct.at4 = value
    def update_audio : CFuncPtr3[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean, Double, Unit] = struct._5
    def update_audio_=(value: CFuncPtr3[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean, Double, Unit]): Unit = !struct.at5 = value
...
object GtkMountOperation:
  ...
  extension (struct: GtkMountOperation)
    def parent_instance : _root_.sn.gnome.gio.internal.GMountOperation = struct._1
    def parent_instance_=(value: _root_.sn.gnome.gio.internal.GMountOperation): Unit = !struct.at1 = value
...
*/
opaque type GtkMountOperationClass = CStruct5[_root_.sn.gnome.gio.internal.GMountOperationClass, CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object GtkMountOperationClass:
  given _tag: Tag[GtkMountOperationClass] = Tag.materializeCStruct5Tag[_root_.sn.gnome.gio.internal.GMountOperationClass, CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[GtkMountOperationClass] = scala.scalanative.unsafe.alloc[GtkMountOperationClass](1)
  def apply(parent_class : _root_.sn.gnome.gio.internal.GMountOperationClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkMountOperationClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
  ...
  extension (struct: GtkMountOperationClass)
    def parent_class : _root_.sn.gnome.gio.internal.GMountOperationClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gio.internal.GMountOperationClass): Unit = !struct.at1 = value
    def _gtk_reserved1 : CFuncPtr0[Unit] = struct._2
    def _gtk_reserved1_=(value: CFuncPtr0[Unit]): Unit = !struct.at2 = value
    def _gtk_reserved2 : CFuncPtr0[Unit] = struct._3
    def _gtk_reserved2_=(value: CFuncPtr0[Unit]): Unit = !struct.at3 = value
...
object GtkNativeDialog:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[GtkNativeDialog] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object GtkNoSelectionClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkNoSelectionClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
*/
opaque type GtkPadActionEntry = CStruct5[GtkPadActionType, CInt, CInt, Ptr[CUnsignedChar], Ptr[CUnsignedChar]]
object GtkPadActionEntry:
  given _tag: Tag[GtkPadActionEntry] = Tag.materializeCStruct5Tag[GtkPadActionType, CInt, CInt, Ptr[CUnsignedChar], Ptr[CUnsignedChar]]
  def apply()(using Zone): Ptr[GtkPadActionEntry] = scala.scalanative.unsafe.alloc[GtkPadActionEntry](1)
  def apply(`type` : GtkPadActionType, index : CInt, mode : CInt, label : Ptr[CUnsignedChar], action_name : Ptr[CUnsignedChar])(using Zone): Ptr[GtkPadActionEntry] = 
    val ____ptr = apply()
    (!____ptr).`type` = `type`
    (!____ptr).index = index
    (!____ptr).mode = mode
  ...
  extension (struct: GtkPadActionEntry)
    ...
    def label : Ptr[CUnsignedChar] = struct._4
    def label_=(value: Ptr[CUnsignedChar]): Unit = !struct.at4 = value
    def action_name : Ptr[CUnsignedChar] = struct._5
    def action_name_=(value: Ptr[CUnsignedChar]): Unit = !struct.at5 = value
...
object GtkPopoverClass:
  ...
  def apply(parent_class : GtkWidgetClass, closed : CFuncPtr1[Ptr[GtkPopover], Unit], activate_default : CFuncPtr1[Ptr[GtkPopover], Unit], reserved : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkPopoverClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
...
object GtkPrintOperationClass:
  ...
  extension (struct: GtkPrintOperationClass)
    ...
    def paginate : CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], _root_.sn.gnome.glib.internal.gboolean] = struct._4
    def paginate_=(value: CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at4 = value
    ...
    def preview : CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintOperationPreview], Ptr[GtkPrintContext], Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean] = struct._11
    def preview_=(value: CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintOperationPreview], Ptr[GtkPrintContext], Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at11 = value
...
object GtkPrintOperationPreviewIface:
  ...
  extension (struct: GtkPrintOperationPreviewIface)
    ...
    def is_selected : CFuncPtr2[Ptr[GtkPrintOperationPreview], CInt, _root_.sn.gnome.glib.internal.gboolean] = struct._5
    def is_selected_=(value: CFuncPtr2[Ptr[GtkPrintOperationPreview], CInt, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at5 = value
...
object GtkRangeClass:
  ...
  def apply(parent_class : GtkWidgetClass, value_changed : CFuncPtr1[Ptr[GtkRange], Unit], adjust_bounds : CFuncPtr2[Ptr[GtkRange], Double, Unit], move_slider : CFuncPtr2[Ptr[GtkRange], GtkScrollType, Unit], get_range_border : CFuncPtr2[Ptr[GtkRange], Ptr[GtkBorder], Unit], change_value : CFuncPtr3[Ptr[GtkRange], GtkScrollType, Double, _root_.sn.gnome.glib.internal.gboolean], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkRangeClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).value_changed = value_changed
  ...
  extension (struct: GtkRangeClass)
    ...
    def change_value : CFuncPtr3[Ptr[GtkRange], GtkScrollType, Double, _root_.sn.gnome.glib.internal.gboolean] = struct._6
    def change_value_=(value: CFuncPtr3[Ptr[GtkRange], GtkScrollType, Double, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at6 = value
...
*/
opaque type GtkRecentData = CStruct7[Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gboolean]
object GtkRecentData:
  given _tag: Tag[GtkRecentData] = Tag.materializeCStruct7Tag[Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gboolean]
  def apply()(using Zone): Ptr[GtkRecentData] = scala.scalanative.unsafe.alloc[GtkRecentData](1)
  def apply(display_name : Ptr[CUnsignedChar], description : Ptr[CUnsignedChar], mime_type : Ptr[CUnsignedChar], app_name : Ptr[CUnsignedChar], app_exec : Ptr[CUnsignedChar], groups : Ptr[Ptr[CUnsignedChar]], is_private : _root_.sn.gnome.glib.internal.gboolean)(using Zone): Ptr[GtkRecentData] = 
    val ____ptr = apply()
  ...
  extension (struct: GtkRecentData)
    def display_name : Ptr[CUnsignedChar] = struct._1
    def display_name_=(value: Ptr[CUnsignedChar]): Unit = !struct.at1 = value
    def description : Ptr[CUnsignedChar] = struct._2
    def description_=(value: Ptr[CUnsignedChar]): Unit = !struct.at2 = value
    def mime_type : Ptr[CUnsignedChar] = struct._3
    def mime_type_=(value: Ptr[CUnsignedChar]): Unit = !struct.at3 = value
    def app_name : Ptr[CUnsignedChar] = struct._4
    def app_name_=(value: Ptr[CUnsignedChar]): Unit = !struct.at4 = value
    def app_exec : Ptr[CUnsignedChar] = struct._5
    def app_exec_=(value: Ptr[CUnsignedChar]): Unit = !struct.at5 = value
    def groups : Ptr[Ptr[CUnsignedChar]] = struct._6
    def groups_=(value: Ptr[Ptr[CUnsignedChar]]): Unit = !struct.at6 = value
...
object GtkRecentManager:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GtkRecentManagerPrivate])(using Zone): Ptr[GtkRecentManager] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).priv = priv
    ____ptr
...
*/
opaque type GtkRecentManagerClass = CStruct6[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr1[Ptr[GtkRecentManager], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object GtkRecentManagerClass:
  given _tag: Tag[GtkRecentManagerClass] = Tag.materializeCStruct6Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr1[Ptr[GtkRecentManager], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[GtkRecentManagerClass] = scala.scalanative.unsafe.alloc[GtkRecentManagerClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, changed : CFuncPtr1[Ptr[GtkRecentManager], Unit], _gtk_recent1 : CFuncPtr0[Unit], _gtk_recent2 : CFuncPtr0[Unit], _gtk_recent3 : CFuncPtr0[Unit], _gtk_recent4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkRecentManagerClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).changed = changed
 ...
 * GtkRequestedSize:
*/
opaque type GtkRequestedSize = CStruct3[_root_.sn.gnome.glib.internal.gpointer, CInt, CInt]
object GtkRequestedSize:
  given _tag: Tag[GtkRequestedSize] = Tag.materializeCStruct3Tag[_root_.sn.gnome.glib.internal.gpointer, CInt, CInt]
  def apply()(using Zone): Ptr[GtkRequestedSize] = scala.scalanative.unsafe.alloc[GtkRequestedSize](1)
  def apply(data : _root_.sn.gnome.glib.internal.gpointer, minimum_size : CInt, natural_size : CInt)(using Zone): Ptr[GtkRequestedSize] = 
    val ____ptr = apply()
    (!____ptr).data = data
...
object GtkScaleClass:
  ...
  def apply(parent_class : GtkRangeClass, get_layout_offsets : CFuncPtr3[Ptr[GtkScale], Ptr[CInt], Ptr[CInt], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkScaleClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
...
object GtkSelectionFilterModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkSelectionFilterModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkSelectionModelInterface:
  given _tag: Tag[GtkSelectionModelInterface] = Tag.materializeCStruct10Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[GtkBitset]], CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr4[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkSelectionModel], Ptr[GtkBitset], Ptr[GtkBitset], _root_.sn.gnome.glib.internal.gboolean]]
  def apply()(using Zone): Ptr[GtkSelectionModelInterface] = scala.scalanative.unsafe.alloc[GtkSelectionModelInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, is_selected : CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], get_selection_in_range : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[GtkBitset]], select_item : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], unselect_item : CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], select_range : CFuncPtr4[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], unselect_range : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean], select_all : CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean], unselect_all : CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean], set_selection : CFuncPtr3[Ptr[GtkSelectionModel], Ptr[GtkBitset], Ptr[GtkBitset], _root_.sn.gnome.glib.internal.gboolean])(using Zone): Ptr[GtkSelectionModelInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).is_selected = is_selected
  ...
  extension (struct: GtkSelectionModelInterface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def is_selected : CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def is_selected_=(value: CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
    def get_selection_in_range : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[GtkBitset]] = struct._3
    def get_selection_in_range_=(value: CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Ptr[GtkBitset]]): Unit = !struct.at3 = value
    def select_item : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._4
    def select_item_=(value: CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at4 = value
    def unselect_item : CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean] = struct._5
    def unselect_item_=(value: CFuncPtr2[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at5 = value
    def select_range : CFuncPtr4[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._6
    def select_range_=(value: CFuncPtr4[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at6 = value
    def unselect_range : CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean] = struct._7
    def unselect_range_=(value: CFuncPtr3[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at7 = value
    def select_all : CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean] = struct._8
    def select_all_=(value: CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at8 = value
    def unselect_all : CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean] = struct._9
    def unselect_all_=(value: CFuncPtr1[Ptr[GtkSelectionModel], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at9 = value
...
object GtkShortcutClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkShortcutClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
*/
opaque type GtkShortcutManagerInterface = CStruct3[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit], CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit]]
object GtkShortcutManagerInterface:
  given _tag: Tag[GtkShortcutManagerInterface] = Tag.materializeCStruct3Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit], CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit]]
  def apply()(using Zone): Ptr[GtkShortcutManagerInterface] = scala.scalanative.unsafe.alloc[GtkShortcutManagerInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, add_controller : CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit], remove_controller : CFuncPtr2[Ptr[GtkShortcutManager], Ptr[GtkShortcutController], Unit])(using Zone): Ptr[GtkShortcutManagerInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
...
object GtkSliceListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkSliceListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkSortListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkSortListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
*/
opaque type GtkSorterClass = CStruct11[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr3[Ptr[GtkSorter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, GtkOrdering], CFuncPtr1[Ptr[GtkSorter], GtkSorterOrder], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object GtkSorterClass:
  given _tag: Tag[GtkSorterClass] = Tag.materializeCStruct11Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr3[Ptr[GtkSorter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, GtkOrdering], CFuncPtr1[Ptr[GtkSorter], GtkSorterOrder], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  ...
  extension (struct: GtkSorterClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def compare : CFuncPtr3[Ptr[GtkSorter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, GtkOrdering] = struct._2
    def compare_=(value: CFuncPtr3[Ptr[GtkSorter], _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, GtkOrdering]): Unit = !struct.at2 = value
...
object GtkStringObjectClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkStringObjectClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
*/
opaque type GtkTextBufferClass = CStruct20[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object GtkTextBufferClass:
  given _tag: Tag[GtkTextBufferClass] = Tag.materializeCStruct20Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[GtkTextBufferClass] = scala.scalanative.unsafe.alloc[GtkTextBufferClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, insert_text : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit], insert_paintable : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GdkPaintable], Unit], insert_child_anchor : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], delete_range : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], changed : CFuncPtr1[Ptr[GtkTextBuffer], Unit], modified_changed : CFuncPtr1[Ptr[GtkTextBuffer], Unit], mark_set : CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], mark_deleted : CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], apply_tag : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], remove_tag : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], begin_user_action : CFuncPtr1[Ptr[GtkTextBuffer], Unit], end_user_action : CFuncPtr1[Ptr[GtkTextBuffer], Unit], paste_done : CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GdkClipboard], Unit], undo : CFuncPtr1[Ptr[GtkTextBuffer], Unit], redo : CFuncPtr1[Ptr[GtkTextBuffer], Unit], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkTextBufferClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).insert_text = insert_text
  ...
  extension (struct: GtkTextBufferClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def insert_text : CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit] = struct._2
    def insert_text_=(value: CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit]): Unit = !struct.at2 = value
...
object GtkTextChildAnchor:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, segment : _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[GtkTextChildAnchor] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
...
object GtkTextChildAnchorClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkTextChildAnchorClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
...
object GtkTextIter:
  ...
  extension (struct: GtkTextIter)
    def dummy1 : _root_.sn.gnome.glib.internal.gpointer = struct._1
    def dummy1_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at1 = value
    def dummy2 : _root_.sn.gnome.glib.internal.gpointer = struct._2
    def dummy2_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at2 = value
    ...
    def dummy9 : _root_.sn.gnome.glib.internal.gpointer = struct._9
    def dummy9_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at9 = value
    def dummy10 : _root_.sn.gnome.glib.internal.gpointer = struct._10
    def dummy10_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at10 = value
...
object GtkTextMark:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, segment : _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[GtkTextMark] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).segment = segment
    ____ptr
...
*/
opaque type GtkTextViewClass = CStruct15[GtkWidgetClass, CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkTextView], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object GtkTextViewClass:
  given _tag: Tag[GtkTextViewClass] = Tag.materializeCStruct15Tag[GtkWidgetClass, CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkTextView], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[GtkTextViewClass] = scala.scalanative.unsafe.alloc[GtkTextViewClass](1)
  def apply(parent_class : GtkWidgetClass, move_cursor : CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], set_anchor : CFuncPtr1[Ptr[GtkTextView], Unit], insert_at_cursor : CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], delete_from_cursor : CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], backspace : CFuncPtr1[Ptr[GtkTextView], Unit], cut_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], copy_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], paste_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], toggle_overwrite : CFuncPtr1[Ptr[GtkTextView], Unit], create_buffer : CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], snapshot_layer : CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], extend_selection : CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], insert_emoji : CFuncPtr1[Ptr[GtkTextView], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkTextViewClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkTextViewClass)
    def parent_class : GtkWidgetClass = struct._1
    def parent_class_=(value: GtkWidgetClass): Unit = !struct.at1 = value
    def move_cursor : CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit] = struct._2
    def move_cursor_=(value: CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit]): Unit = !struct.at2 = value
    ...
    def insert_at_cursor : CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit] = struct._4
    def insert_at_cursor_=(value: CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit]): Unit = !struct.at4 = value
    ...
    def extend_selection : CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean] = struct._13
    def extend_selection_=(value: CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at13 = value
...
object GtkTreeDragDestIface:
  ...
  extension (struct: GtkTreeDragDestIface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def drag_data_received : CFuncPtr3[Ptr[GtkTreeDragDest], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gobject.internal.GValue], _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def drag_data_received_=(value: CFuncPtr3[Ptr[GtkTreeDragDest], Ptr[GtkTreePath], Ptr[_root_.sn.gnome.gobject.internal.GValue], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
...
object GtkTreeDragSourceIface:
  ...
  extension (struct: GtkTreeDragSourceIface)
    def g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface = struct._1
    def g_iface_=(value: _root_.sn.gnome.gobject.internal.GTypeInterface): Unit = !struct.at1 = value
    def row_draggable : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def row_draggable_=(value: CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
...
object GtkTreeIter:
  ...
  extension (struct: GtkTreeIter)
    ...
    def user_data : _root_.sn.gnome.glib.internal.gpointer = struct._2
    def user_data_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at2 = value
    def user_data2 : _root_.sn.gnome.glib.internal.gpointer = struct._3
    def user_data2_=(value: _root_.sn.gnome.glib.internal.gpointer): Unit = !struct.at3 = value
...
object GtkTreeListModelClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkTreeListModelClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkTreeListRowClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkTreeListRowClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkTreeModelFilterClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, visible : CFuncPtr3[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], modify : CFuncPtr5[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[_root_.sn.gnome.gobject.internal.GValue], CInt, Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkTreeModelFilterClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
  ...
  extension (struct: GtkTreeModelFilterClass)
    def parent_class : _root_.sn.gnome.gobject.internal.GObjectClass = struct._1
    def parent_class_=(value: _root_.sn.gnome.gobject.internal.GObjectClass): Unit = !struct.at1 = value
    def visible : CFuncPtr3[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._2
    def visible_=(value: CFuncPtr3[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at2 = value
    def modify : CFuncPtr5[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[_root_.sn.gnome.gobject.internal.GValue], CInt, Unit] = struct._3
    def modify_=(value: CFuncPtr5[Ptr[GtkTreeModelFilter], Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[_root_.sn.gnome.gobject.internal.GValue], CInt, Unit]): Unit = !struct.at3 = value
    def padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8] = struct._4
    def padding_=(value: CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]): Unit = !struct.at4 = value
...
*/
opaque type GtkTreeModelIface = CStruct21[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreePath], Unit], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Ptr[CInt], Unit], CFuncPtr1[Ptr[GtkTreeModel], GtkTreeModelFlags], CFuncPtr1[Ptr[GtkTreeModel], CInt], CFuncPtr2[Ptr[GtkTreeModel], CInt, _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath]], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt, Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], CInt, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Unit]]
object GtkTreeModelIface:
  given _tag: Tag[GtkTreeModelIface] = Tag.materializeCStruct21Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreePath], Unit], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreePath], Ptr[GtkTreeIter], Ptr[CInt], Unit], CFuncPtr1[Ptr[GtkTreeModel], GtkTreeModelFlags], CFuncPtr1[Ptr[GtkTreeModel], CInt], CFuncPtr2[Ptr[GtkTreeModel], CInt, _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath]], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt, Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt], CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], CInt, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Unit], CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Unit]]
  ...
  extension (struct: GtkTreeModelIface)
    ...
    def get_column_type : CFuncPtr2[Ptr[GtkTreeModel], CInt, _root_.sn.gnome.gobject.internal.GType] = struct._9
    def get_column_type_=(value: CFuncPtr2[Ptr[GtkTreeModel], CInt, _root_.sn.gnome.gobject.internal.GType]): Unit = !struct.at9 = value
    def get_iter : CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean] = struct._10
    def get_iter_=(value: CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at10 = value
    ...
    def get_value : CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt, Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit] = struct._12
    def get_value_=(value: CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], CInt, Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit]): Unit = !struct.at12 = value
    def iter_next : CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._13
    def iter_next_=(value: CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at13 = value
    def iter_previous : CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._14
    def iter_previous_=(value: CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at14 = value
    def iter_children : CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._15
    def iter_children_=(value: CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at15 = value
    def iter_has_child : CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._16
    def iter_has_child_=(value: CFuncPtr2[Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at16 = value
    ...
    def iter_nth_child : CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], CInt, _root_.sn.gnome.glib.internal.gboolean] = struct._18
    def iter_nth_child_=(value: CFuncPtr4[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], CInt, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at18 = value
    def iter_parent : CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean] = struct._19
    def iter_parent_=(value: CFuncPtr3[Ptr[GtkTreeModel], Ptr[GtkTreeIter], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at19 = value
...
object GtkTreeModelSortClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkTreeModelSortClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkTreeSortableIface:
  ...
  extension (struct: GtkTreeSortableIface)
    ...
    def get_sort_column_id : CFuncPtr3[Ptr[GtkTreeSortable], Ptr[CInt], Ptr[GtkSortType], _root_.sn.gnome.glib.internal.gboolean] = struct._3
    def get_sort_column_id_=(value: CFuncPtr3[Ptr[GtkTreeSortable], Ptr[CInt], Ptr[GtkSortType], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at3 = value
    ...
    def set_sort_func : CFuncPtr5[Ptr[GtkTreeSortable], CInt, GtkTreeIterCompareFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit] = struct._5
    def set_sort_func_=(value: CFuncPtr5[Ptr[GtkTreeSortable], CInt, GtkTreeIterCompareFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit]): Unit = !struct.at5 = value
    def set_default_sort_func : CFuncPtr4[Ptr[GtkTreeSortable], GtkTreeIterCompareFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit] = struct._6
    def set_default_sort_func_=(value: CFuncPtr4[Ptr[GtkTreeSortable], GtkTreeIterCompareFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit]): Unit = !struct.at6 = value
...
object GtkTreeStoreClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[GtkTreeStoreClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object GtkTreeViewClass:
  ...
  extension (struct: GtkTreeViewClass)
    ...
    def test_expand_row : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean] = struct._3
    def test_expand_row_=(value: CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at3 = value
    def test_collapse_row : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean] = struct._4
    def test_collapse_row_=(value: CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at4 = value
    ...
    def move_cursor : CFuncPtr5[Ptr[GtkTreeView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._9
    def move_cursor_=(value: CFuncPtr5[Ptr[GtkTreeView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at9 = value
    def select_all : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean] = struct._10
    def select_all_=(value: CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at10 = value
    def unselect_all : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean] = struct._11
    def unselect_all_=(value: CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at11 = value
    def select_cursor_row : CFuncPtr2[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._12
    def select_cursor_row_=(value: CFuncPtr2[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at12 = value
    def toggle_cursor_row : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean] = struct._13
    def toggle_cursor_row_=(value: CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at13 = value
    def expand_collapse_cursor_row : CFuncPtr4[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._14
    def expand_collapse_cursor_row_=(value: CFuncPtr4[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at14 = value
    def select_cursor_parent : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean] = struct._15
    def select_cursor_parent_=(value: CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at15 = value
    def start_interactive_search : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean] = struct._16
    def start_interactive_search_=(value: CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at16 = value
...
object GtkWidgetPaintableClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[GtkWidgetPaintableClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
...
object GtkWindowClass:
  ...
  extension (struct: GtkWindowClass)
    ...
    def enable_debugging : CFuncPtr2[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean] = struct._5
    def enable_debugging_=(value: CFuncPtr2[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at5 = value
    def close_request : CFuncPtr1[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean] = struct._6
    def close_request_=(value: CFuncPtr1[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean]): Unit = !struct.at6 = value
    def padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8] = struct._7
    def padding_=(value: CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]): Unit = !struct.at7 = value
...
object GtkWindowGroupClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GtkWindowGroupClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
...
object _GtkAccessibleTextInterface:
  ...
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_contents : CFuncPtr3[Ptr[GtkAccessibleText], CUnsignedInt, CUnsignedInt, Ptr[_root_.sn.gnome.glib.internal.GBytes]], get_contents_at : CFuncPtr5[Ptr[GtkAccessibleText], CUnsignedInt, GtkAccessibleTextGranularity, Ptr[CUnsignedInt], Ptr[CUnsignedInt], Ptr[_root_.sn.gnome.glib.internal.GBytes]], get_caret_position : CFuncPtr1[Ptr[GtkAccessibleText], CUnsignedInt], get_selection : CFuncPtr3[Ptr[GtkAccessibleText], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[Ptr[GtkAccessibleTextRange]], _root_.sn.gnome.glib.internal.gboolean], get_attributes : CFuncPtr6[Ptr[GtkAccessibleText], CUnsignedInt, Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[Ptr[GtkAccessibleTextRange]], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], _root_.sn.gnome.glib.internal.gboolean], get_default_attributes : CFuncPtr3[Ptr[GtkAccessibleText], Ptr[Ptr[Ptr[CUnsignedChar]]], Ptr[Ptr[Ptr[CUnsignedChar]]], Unit])(using Zone): Ptr[_GtkAccessibleTextInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).get_contents = get_contents
    (!____ptr).get_contents_at = get_contents_at
...
object _GtkActionableInterface:
  ...
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_action_name : CFuncPtr1[Ptr[GtkActionable], Ptr[CUnsignedChar]], set_action_name : CFuncPtr2[Ptr[GtkActionable], Ptr[CUnsignedChar], Unit], get_action_target_value : CFuncPtr1[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant]], set_action_target_value : CFuncPtr2[Ptr[GtkActionable], Ptr[_root_.sn.gnome.glib.internal.GVariant], Unit])(using Zone): Ptr[_GtkActionableInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).get_action_name = get_action_name
    (!____ptr).set_action_name = set_action_name
 ...
 * GtkBuildableIface: _iface: the parent class
*/
opaque type _GtkBuildableIface = CStruct11[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]]
object _GtkBuildableIface:
  given _tag: Tag[_GtkBuildableIface] = Tag.materializeCStruct11Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]]]
  def apply()(using Zone): Ptr[_GtkBuildableIface] = scala.scalanative.unsafe.alloc[_GtkBuildableIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, set_id : CFuncPtr2[Ptr[GtkBuildable], Ptr[CUnsignedChar], Unit], get_id : CFuncPtr1[Ptr[GtkBuildable], Ptr[CUnsignedChar]], add_child : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Unit], set_buildable_property : CFuncPtr4[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GValue], Unit], construct_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]], custom_tag_start : CFuncPtr6[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], Ptr[GtkBuildableParser], Ptr[_root_.sn.gnome.glib.internal.gpointer], _root_.sn.gnome.glib.internal.gboolean], custom_tag_end : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], custom_finished : CFuncPtr5[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Unit], parser_finished : CFuncPtr2[Ptr[GtkBuildable], Ptr[GtkBuilder], Unit], get_internal_child : CFuncPtr3[Ptr[GtkBuildable], Ptr[GtkBuilder], Ptr[CUnsignedChar], Ptr[_root_.sn.gnome.gobject.internal.GObject]])(using Zone): Ptr[_GtkBuildableIface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).set_id = set_id
    (!____ptr).get_id = get_id
 ...
 * GtkBuildableParser: _element: function called for open elements _element: function called for close elements
*/
opaque type _GtkBuildableParser = CStruct5[CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._4]]
object _GtkBuildableParser:
  ...
  def apply(start_element : CFuncPtr6[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], end_element : CFuncPtr4[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], text : CFuncPtr5[Ptr[GtkBuildableParseContext], Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.gsize, _root_.sn.gnome.glib.internal.gpointer, Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Unit], error : CFuncPtr3[Ptr[GtkBuildableParseContext], Ptr[_root_.sn.gnome.glib.internal.GError], _root_.sn.gnome.glib.internal.gpointer, Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._4])(using Zone): Ptr[_GtkBuildableParser] = 
    val ____ptr = apply()
    (!____ptr).start_element = start_element
    (!____ptr).end_element = end_element
    (!____ptr).text = text
...
object _GtkBuilderCScopeClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass)(using Zone): Ptr[_GtkBuilderCScopeClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    ____ptr
 ...
 * GtkBuilderScopeInterface: _type_from_name: Try to lookup a `GType` via the its name. See gtk_builder_get_type_from_name() for more details. The C implementation will use g_type_from_name() and if that fails try to guess the correct function name for registering the type and then use dlsym() to load it. The default implementation just tries g_type_from_name() and otherwise fails. _type_from_function: Try to lookup a `GType` via the given function name, specified explicitly in a GtkBuilder file, like via the "type-func" attribute in the `<object>` tag. This function is very rarely used. The C implementation will use dlsym() and call the resulting function as a `GTypeFunc`. The default implementation will fail and just return %G_TYPE_INVALID. _closure: Create a closure with the given arguments. See gtk_builder_create_closure() for more details on those. The C implementation will try to use dlsym() to locate the function name and then g_cclosure_new() to create a closure for the symbol. The default implementation just fails and returns %NULL.
*/
opaque type _GtkBuilderScopeInterface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[Byte]]]
object _GtkBuilderScopeInterface:
  given _tag: Tag[_GtkBuilderScopeInterface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[Byte]]]
  def apply()(using Zone): Ptr[_GtkBuilderScopeInterface] = scala.scalanative.unsafe.alloc[_GtkBuilderScopeInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_type_from_name : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], get_type_from_function : CFuncPtr3[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], _root_.sn.gnome.gobject.internal.GType], create_closure : CFuncPtr6[Ptr[GtkBuilderScope], Ptr[GtkBuilder], Ptr[CUnsignedChar], GtkBuilderClosureFlags, Ptr[_root_.sn.gnome.gobject.internal.GObject], Ptr[Ptr[_root_.sn.gnome.glib.internal.GError]], Ptr[_root_.sn.gnome.gobject.internal.GClosure]])(using Zone): Ptr[_GtkBuilderScopeInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).get_type_from_name = get_type_from_name
    (!____ptr).get_type_from_function = get_type_from_function
 ...
 * GtkButtonClass: _class: The parent class. : Signal emitted when the button has been activated (pressed and released). : Signal that causes the button to animate press then release. Applications should never connect to this signal, but use the signal.
*/
opaque type _GtkButtonClass = CStruct4[GtkWidgetClass, CFuncPtr1[Ptr[GtkButton], Unit], CFuncPtr1[Ptr[GtkButton], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkButtonClass:
  given _tag: Tag[_GtkButtonClass] = Tag.materializeCStruct4Tag[GtkWidgetClass, CFuncPtr1[Ptr[GtkButton], Unit], CFuncPtr1[Ptr[GtkButton], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkButtonClass] = scala.scalanative.unsafe.alloc[_GtkButtonClass](1)
  def apply(parent_class : GtkWidgetClass, clicked : CFuncPtr1[Ptr[GtkButton], Unit], activate : CFuncPtr1[Ptr[GtkButton], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkButtonClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).clicked = clicked
    (!____ptr).activate = activate
 ...
 * GtkCellAreaClass: : adds a `GtkCellRenderer` to the area. : removes a `GtkCellRenderer` from the area. : calls the `GtkCellCallback` function on every `GtkCellRenderer` in the area with the provided user data until the callback returns %TRUE. _alloc: Calls the `GtkCellAllocCallback` function on every `GtkCellRenderer` in the area with the allocated area for the cell and the provided user data until the callback returns %TRUE. : Handle an event in the area, this is generally used to activate a cell at the event location for button events but can also be used to generically pass events to `GtkWidget`s drawn onto the area. : Actually snapshot the area’s cells to the specified rectangle, _area should be correctly distributed to the cells corresponding background areas. _attributes: Apply the cell attributes to the cells. This is implemented as a signal and generally `GtkCellArea` subclasses don't need to implement it since it is handled by the base class. _context: Creates and returns a class specific `GtkCellAreaContext` to store cell alignment and allocation details for a said `GtkCellArea` class. _context: Creates a new `GtkCellAreaContext` in the same state as the passed with any cell alignment data and allocations intact. _request_mode: This allows an area to tell its layouting widget whether it prefers to be allocated in %GTK_SIZE_REQUEST_HEIGHT_FOR_WIDTH or %GTK_SIZE_REQUEST_WIDTH_FOR_HEIGHT mode. _preferred_width: Calculates the minimum and natural width of the areas cells with the current attributes applied while considering the particular layouting details of the said `GtkCellArea`. While requests are performed over a series of rows, alignments and overall minimum and natural sizes should be stored in the corresponding `GtkCellAreaContext`. _preferred_height_for_width: Calculates the minimum and natural height for the area if the passed would be allocated the given width. When implementing this virtual method it is safe to assume that has already stored the aligned cell widths for every `GtkTreeModel` row that will be allocated for since this information was stored at `GtkCellAreaClass.get_preferred_width()` time. This virtual method should also store any necessary alignments of cell heights for the case that the context is allocated a height. _preferred_height: Calculates the minimum and natural height of the areas cells with the current attributes applied. Essentially this is the same as `GtkCellAreaClass.get_preferred_width()` only for areas that are being requested as %GTK_SIZE_REQUEST_WIDTH_FOR_HEIGHT. _preferred_width_for_height: Calculates the minimum and natural width for the area if the passed would be allocated the given height. The same as `GtkCellAreaClass.get_preferred_height_for_width()` only for handling requests in the %GTK_SIZE_REQUEST_WIDTH_FOR_HEIGHT mode.
*/
opaque type _GtkCellAreaClass = CStruct21[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkCellAreaClass:
  given _tag: Tag[_GtkCellAreaClass] = Tag.materializeCStruct21Tag[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkCellAreaClass] = scala.scalanative.unsafe.alloc[_GtkCellAreaClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, add : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], remove : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellRenderer], Unit], foreach : CFuncPtr3[Ptr[GtkCellArea], GtkCellCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], foreach_alloc : CFuncPtr7[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellAllocCallback, _root_.sn.gnome.glib.internal.gpointer, Unit], event : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkEvent], Ptr[GdkRectangle], GtkCellRendererState, CInt], snapshot : CFuncPtr8[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GtkSnapshot], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, Unit], apply_attributes : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkTreeModel], Ptr[GtkTreeIter], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, Unit], create_context : CFuncPtr1[Ptr[GtkCellArea], Ptr[GtkCellAreaContext]], copy_context : CFuncPtr2[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkCellAreaContext]], get_request_mode : CFuncPtr1[Ptr[GtkCellArea], GtkSizeRequestMode], get_preferred_width : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_height_for_width : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_preferred_height : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_width_for_height : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], set_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], get_cell_property : CFuncPtr5[Ptr[GtkCellArea], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.guint, Ptr[_root_.sn.gnome.gobject.internal.GValue], Ptr[_root_.sn.gnome.gobject.internal.GParamSpec], Unit], focus : CFuncPtr2[Ptr[GtkCellArea], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], is_activatable : CFuncPtr1[Ptr[GtkCellArea], _root_.sn.gnome.glib.internal.gboolean], activate : CFuncPtr6[Ptr[GtkCellArea], Ptr[GtkCellAreaContext], Ptr[GtkWidget], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkCellAreaClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).add = add
    (!____ptr).remove = remove
...
object _GtkCellAreaContext:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkCellAreaContext] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkCellLayoutIface:
  given _tag: Tag[_GtkCellLayoutIface] = Tag.materializeCStruct10Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkCellLayout], Unit], CFuncPtr4[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr5[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], GtkCellLayoutDataFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellLayout], Ptr[GtkCellRenderer], CInt, Unit], CFuncPtr1[Ptr[GtkCellLayout], Ptr[Byte]], CFuncPtr1[Ptr[GtkCellLayout], Ptr[GtkCellArea]]]
 ...
 * GtkCellRendererClass: _request_mode: Called to gets whether the cell renderer prefers a height-for-width layout or a width-for-height layout. _preferred_width: Called to get a renderer’s natural width. _preferred_height_for_width: Called to get a renderer’s natural height for width. _preferred_height: Called to get a renderer’s natural height. _preferred_width_for_height: Called to get a renderer’s natural width for height. _aligned_area: Called to get the aligned area used by inside _area. : Called to snapshot the content of the `GtkCellRenderer`. : Called to activate the content of the `GtkCellRenderer`. _editing: Called to initiate editing the content of the `GtkCellRenderer`. _canceled: Signal gets emitted when the user cancels the process of editing a cell. _started: Signal gets emitted when a cell starts to be edited.
*/
opaque type _GtkCellRendererClass = CStruct13[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], CFuncPtr1[Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkCellRendererClass:
  given _tag: Tag[_GtkCellRendererClass] = Tag.materializeCStruct13Tag[_root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], CFuncPtr1[Ptr[GtkCellRenderer], Unit], CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkCellRendererClass] = scala.scalanative.unsafe.alloc[_GtkCellRendererClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, get_request_mode : CFuncPtr1[Ptr[GtkCellRenderer], GtkSizeRequestMode], get_preferred_width : CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_height_for_width : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_preferred_height : CFuncPtr4[Ptr[GtkCellRenderer], Ptr[GtkWidget], Ptr[CInt], Ptr[CInt], Unit], get_preferred_width_for_height : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], CInt, Ptr[CInt], Ptr[CInt], Unit], get_aligned_area : CFuncPtr5[Ptr[GtkCellRenderer], Ptr[GtkWidget], GtkCellRendererState, Ptr[GdkRectangle], Ptr[GdkRectangle], Unit], snapshot : CFuncPtr6[Ptr[GtkCellRenderer], Ptr[GtkSnapshot], Ptr[GtkWidget], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Unit], activate : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, _root_.sn.gnome.glib.internal.gboolean], start_editing : CFuncPtr7[Ptr[GtkCellRenderer], Ptr[GdkEvent], Ptr[GtkWidget], Ptr[CUnsignedChar], Ptr[GdkRectangle], Ptr[GdkRectangle], GtkCellRendererState, Ptr[GtkCellEditable]], editing_canceled : CFuncPtr1[Ptr[GtkCellRenderer], Unit], editing_started : CFuncPtr3[Ptr[GtkCellRenderer], Ptr[GtkCellEditable], Ptr[CUnsignedChar], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkCellRendererClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).get_request_mode = get_request_mode
    (!____ptr).get_preferred_width = get_preferred_width
...
opaque type _GtkCellRendererTextClass = CStruct3[GtkCellRendererClass, CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkCellRendererTextClass:
  given _tag: Tag[_GtkCellRendererTextClass] = Tag.materializeCStruct3Tag[GtkCellRendererClass, CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkCellRendererTextClass] = scala.scalanative.unsafe.alloc[_GtkCellRendererTextClass](1)
  def apply(parent_class : GtkCellRendererClass, edited : CFuncPtr3[Ptr[GtkCellRendererText], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkCellRendererTextClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).edited = edited
    (!____ptr).padding = padding
...
object _GtkCheckButtonClass:
  ...
  def apply(parent_class : GtkWidgetClass, toggled : CFuncPtr1[Ptr[GtkCheckButton], Unit], activate : CFuncPtr1[Ptr[GtkCheckButton], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7])(using Zone): Ptr[_GtkCheckButtonClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).toggled = toggled
    (!____ptr).activate = activate
...
object _GtkColorChooserInterface:
  ...
  def apply(base_interface : _root_.sn.gnome.gobject.internal.GTypeInterface, get_rgba : CFuncPtr2[Ptr[GtkColorChooser], Ptr[GdkRGBA], Unit], set_rgba : CFuncPtr2[Ptr[GtkColorChooser], Ptr[GdkRGBA], Unit], add_palette : CFuncPtr5[Ptr[GtkColorChooser], GtkOrientation, CInt, CInt, Ptr[GdkRGBA], Unit], color_activated : CFuncPtr2[Ptr[GtkColorChooser], Ptr[GdkRGBA], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._2]])(using Zone): Ptr[_GtkColorChooserInterface] = 
    val ____ptr = apply()
    (!____ptr).base_interface = base_interface
    (!____ptr).get_rgba = get_rgba
    (!____ptr).set_rgba = set_rgba
 ...
 * GtkComboBoxClass: _class: The parent class. : Signal is emitted when the active item is changed. _entry_text: Signal which allows you to change how the text displayed in a combo box’s entry is displayed.
*/
opaque type _GtkComboBoxClass = CStruct5[GtkWidgetClass, CFuncPtr1[Ptr[GtkComboBox], Unit], CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkComboBox], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7]]
object _GtkComboBoxClass:
  given _tag: Tag[_GtkComboBoxClass] = Tag.materializeCStruct5Tag[GtkWidgetClass, CFuncPtr1[Ptr[GtkComboBox], Unit], CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkComboBox], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7]]
  def apply()(using Zone): Ptr[_GtkComboBoxClass] = scala.scalanative.unsafe.alloc[_GtkComboBoxClass](1)
  def apply(parent_class : GtkWidgetClass, changed : CFuncPtr1[Ptr[GtkComboBox], Unit], format_entry_text : CFuncPtr2[Ptr[GtkComboBox], Ptr[CUnsignedChar], Ptr[CUnsignedChar]], activate : CFuncPtr1[Ptr[GtkComboBox], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._7])(using Zone): Ptr[_GtkComboBoxClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).changed = changed
    (!____ptr).format_entry_text = format_entry_text
...
object _GtkCssProvider:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkCssProvider] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkEditableInterface:
  given _tag: Tag[_GtkEditableInterface] = Tag.materializeCStruct10Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]], CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkEditable], Ptr[GtkEditable]]]
  def apply()(using Zone): Ptr[_GtkEditableInterface] = scala.scalanative.unsafe.alloc[_GtkEditableInterface](1)
  def apply(base_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], delete_text : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], changed : CFuncPtr1[Ptr[GtkEditable], Unit], get_text : CFuncPtr1[Ptr[GtkEditable], Ptr[CUnsignedChar]], do_insert_text : CFuncPtr4[Ptr[GtkEditable], Ptr[CUnsignedChar], CInt, Ptr[CInt], Unit], do_delete_text : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], get_selection_bounds : CFuncPtr3[Ptr[GtkEditable], Ptr[CInt], Ptr[CInt], _root_.sn.gnome.glib.internal.gboolean], set_selection_bounds : CFuncPtr3[Ptr[GtkEditable], CInt, CInt, Unit], get_delegate : CFuncPtr1[Ptr[GtkEditable], Ptr[GtkEditable]])(using Zone): Ptr[_GtkEditableInterface] = 
    val ____ptr = apply()
    (!____ptr).base_iface = base_iface
    (!____ptr).insert_text = insert_text
    (!____ptr).delete_text = delete_text
...
opaque type _GtkEntryBufferClass = CStruct15[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object _GtkEntryBufferClass:
  given _tag: Tag[_GtkEntryBufferClass] = Tag.materializeCStruct15Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[_GtkEntryBufferClass] = scala.scalanative.unsafe.alloc[_GtkEntryBufferClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, inserted_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, Unit], deleted_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, Unit], get_text : CFuncPtr2[Ptr[GtkEntryBuffer], Ptr[_root_.sn.gnome.glib.internal.gsize], Ptr[CUnsignedChar]], get_length : CFuncPtr1[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint], insert_text : CFuncPtr4[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, Ptr[CUnsignedChar], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], delete_text : CFuncPtr3[Ptr[GtkEntryBuffer], _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint, _root_.sn.gnome.glib.internal.guint], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit], _gtk_reserved5 : CFuncPtr0[Unit], _gtk_reserved6 : CFuncPtr0[Unit], _gtk_reserved7 : CFuncPtr0[Unit], _gtk_reserved8 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkEntryBufferClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).inserted_text = inserted_text
    (!____ptr).deleted_text = deleted_text
...
object _GtkFixedClass:
  ...
  def apply(parent_class : GtkWidgetClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkFixedClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
opaque type _GtkFontChooserIface = CStruct9[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFamily]], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFace]], CFuncPtr1[Ptr[GtkFontChooser], CInt], CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap], Unit], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]]]
object _GtkFontChooserIface:
  given _tag: Tag[_GtkFontChooserIface] = Tag.materializeCStruct9Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFamily]], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontFace]], CFuncPtr1[Ptr[GtkFontChooser], CInt], CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[CUnsignedChar], Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap], Unit], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.sn.gnome.pango.internal.PangoFontMap]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._0]]]
 ...
 * GtkGLAreaClass: : class closure for the `GtkGLArea::render` signal : class closeure for the `GtkGLArea::resize` signal _context: class closure for the `GtkGLArea::create-context` signal
*/
opaque type _GtkGLAreaClass = CStruct5[GtkWidgetClass, CFuncPtr2[Ptr[GtkGLArea], Ptr[GdkGLContext], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkGLArea], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkGLArea], Ptr[GdkGLContext]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkGLAreaClass:
  given _tag: Tag[_GtkGLAreaClass] = Tag.materializeCStruct5Tag[GtkWidgetClass, CFuncPtr2[Ptr[GtkGLArea], Ptr[GdkGLContext], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr3[Ptr[GtkGLArea], CInt, CInt, Unit], CFuncPtr1[Ptr[GtkGLArea], Ptr[GdkGLContext]], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkGLAreaClass] = scala.scalanative.unsafe.alloc[_GtkGLAreaClass](1)
  def apply(parent_class : GtkWidgetClass, render : CFuncPtr2[Ptr[GtkGLArea], Ptr[GdkGLContext], _root_.sn.gnome.glib.internal.gboolean], resize : CFuncPtr3[Ptr[GtkGLArea], CInt, CInt, Unit], create_context : CFuncPtr1[Ptr[GtkGLArea], Ptr[GdkGLContext]], _padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkGLAreaClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).render = render
    (!____ptr).resize = resize
...
object _GtkIMContext:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkIMContext] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkLayoutManager:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkLayoutManager] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
 ...
 * GtkLayoutManagerClass: _request_mode: a virtual function, used to return the preferred request mode for the layout manager; for instance, "width for height" or "height for width"; see `GtkSizeRequestMode` : a virtual function, used to measure the minimum and preferred sizes of the widget using the layout manager for a given orientation : a virtual function, used to allocate the size of the widget using the layout manager _child_type: the type of `GtkLayoutChild` used by this layout manager _layout_child: a virtual function, used to create a `GtkLayoutChild` meta object for the layout properties : a virtual function, called when the widget using the layout manager is attached to a `GtkRoot` : a virtual function, called when the widget using the layout manager is detached from a `GtkRoot`
*/
opaque type _GtkLayoutManagerClass = CStruct9[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkSizeRequestMode], CFuncPtr8[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkOrientation, CInt, Ptr[CInt], Ptr[CInt], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkLayoutManager], Ptr[GtkWidget], CInt, CInt, CInt, Unit], _root_.sn.gnome.gobject.internal.GType, CFuncPtr3[Ptr[GtkLayoutManager], Ptr[GtkWidget], Ptr[GtkWidget], Ptr[GtkLayoutChild]], CFuncPtr1[Ptr[GtkLayoutManager], Unit], CFuncPtr1[Ptr[GtkLayoutManager], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._6]]]
object _GtkLayoutManagerClass:
  given _tag: Tag[_GtkLayoutManagerClass] = Tag.materializeCStruct9Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkSizeRequestMode], CFuncPtr8[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkOrientation, CInt, Ptr[CInt], Ptr[CInt], Ptr[CInt], Ptr[CInt], Unit], CFuncPtr5[Ptr[GtkLayoutManager], Ptr[GtkWidget], CInt, CInt, CInt, Unit], _root_.sn.gnome.gobject.internal.GType, CFuncPtr3[Ptr[GtkLayoutManager], Ptr[GtkWidget], Ptr[GtkWidget], Ptr[GtkLayoutChild]], CFuncPtr1[Ptr[GtkLayoutManager], Unit], CFuncPtr1[Ptr[GtkLayoutManager], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._6]]]
  def apply()(using Zone): Ptr[_GtkLayoutManagerClass] = scala.scalanative.unsafe.alloc[_GtkLayoutManagerClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, get_request_mode : CFuncPtr2[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkSizeRequestMode], measure : CFuncPtr8[Ptr[GtkLayoutManager], Ptr[GtkWidget], GtkOrientation, CInt, Ptr[CInt], Ptr[CInt], Ptr[CInt], Ptr[CInt], Unit], allocate : CFuncPtr5[Ptr[GtkLayoutManager], Ptr[GtkWidget], CInt, CInt, CInt, Unit], layout_child_type : _root_.sn.gnome.gobject.internal.GType, create_layout_child : CFuncPtr3[Ptr[GtkLayoutManager], Ptr[GtkWidget], Ptr[GtkWidget], Ptr[GtkLayoutChild]], root : CFuncPtr1[Ptr[GtkLayoutManager], Unit], unroot : CFuncPtr1[Ptr[GtkLayoutManager], Unit], _padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[_GtkLayoutManagerClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).get_request_mode = get_request_mode
    (!____ptr).measure = measure
...
object _GtkListStoreClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkListStoreClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object _GtkMediaStream:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkMediaStream] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkMediaStreamClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, play : CFuncPtr1[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean], pause : CFuncPtr1[Ptr[GtkMediaStream], Unit], seek : CFuncPtr2[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gint64, Unit], update_audio : CFuncPtr3[Ptr[GtkMediaStream], _root_.sn.gnome.glib.internal.gboolean, Double, Unit], realize : CFuncPtr2[Ptr[GtkMediaStream], Ptr[GdkSurface], Unit], unrealize : CFuncPtr2[Ptr[GtkMediaStream], Ptr[GdkSurface], Unit], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit], _gtk_reserved5 : CFuncPtr0[Unit], _gtk_reserved6 : CFuncPtr0[Unit], _gtk_reserved7 : CFuncPtr0[Unit], _gtk_reserved8 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkMediaStreamClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).play = play
    (!____ptr).pause = pause
 ...
 * GtkMountOperationClass: _class: The parent class.
*/
opaque type _GtkMountOperationClass = CStruct5[_root_.sn.gnome.gio.internal.GMountOperationClass, CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object _GtkMountOperationClass:
  given _tag: Tag[_GtkMountOperationClass] = Tag.materializeCStruct5Tag[_root_.sn.gnome.gio.internal.GMountOperationClass, CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[_GtkMountOperationClass] = scala.scalanative.unsafe.alloc[_GtkMountOperationClass](1)
  def apply(parent_class : _root_.sn.gnome.gio.internal.GMountOperationClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkMountOperationClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
...
object _GtkNativeDialog:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkNativeDialog] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
 ...
 * GtkNativeDialogClass: : class handler for the `GtkNativeDialog::response` signal
*/
opaque type _GtkNativeDialogClass = CStruct8[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkNativeDialog], CInt, Unit], CFuncPtr1[Ptr[GtkNativeDialog], Unit], CFuncPtr1[Ptr[GtkNativeDialog], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object _GtkNativeDialogClass:
  given _tag: Tag[_GtkNativeDialogClass] = Tag.materializeCStruct8Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkNativeDialog], CInt, Unit], CFuncPtr1[Ptr[GtkNativeDialog], Unit], CFuncPtr1[Ptr[GtkNativeDialog], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
 ...
 * GtkPadActionEntry: : the type of pad feature that will trigger this action entry. : the 0-indexed button/ring/strip number that will trigger this action entry.
*/
opaque type _GtkPadActionEntry = CStruct5[GtkPadActionType, CInt, CInt, Ptr[CUnsignedChar], Ptr[CUnsignedChar]]
object _GtkPadActionEntry:
  given _tag: Tag[_GtkPadActionEntry] = Tag.materializeCStruct5Tag[GtkPadActionType, CInt, CInt, Ptr[CUnsignedChar], Ptr[CUnsignedChar]]
  def apply()(using Zone): Ptr[_GtkPadActionEntry] = scala.scalanative.unsafe.alloc[_GtkPadActionEntry](1)
  def apply(`type` : GtkPadActionType, index : CInt, mode : CInt, label : Ptr[CUnsignedChar], action_name : Ptr[CUnsignedChar])(using Zone): Ptr[_GtkPadActionEntry] = 
    val ____ptr = apply()
    (!____ptr).`type` = `type`
    (!____ptr).index = index
    (!____ptr).mode = mode
...
object _GtkPrintOperation:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GtkPrintOperationPrivate])(using Zone): Ptr[_GtkPrintOperation] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).priv = priv
    ____ptr
 ...
 * GtkPrintOperationClass: _class: The parent class. : Signal emitted when the print operation run has finished doing everything required for printing. _print: Signal emitted after the user has finished changing print settings in the dialog, before the actual rendering starts. : Signal emitted after the “begin-print” signal, but before the actual rendering starts. _page_setup: Emitted once for every page that is printed, to give the application a chance to modify the page setup. _page: Signal emitted for every page that is printed. _print: Signal emitted after all pages have been rendered. _changed: Emitted at between the various phases of the print operation. _custom_widget: Signal emitted when displaying the print dialog. _widget_apply: Signal emitted right before “begin-print” if you added a custom widget in the “create-custom-widget” handler. : Signal emitted when a preview is requested from the native dialog. _custom_widget: Emitted after change of selected printer.
*/
opaque type _GtkPrintOperationClass = CStruct13[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkPrintOperation], GtkPrintOperationResult, Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Ptr[GtkPageSetup], Unit], CFuncPtr3[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], CFuncPtr1[Ptr[GtkPrintOperation], Unit], CFuncPtr1[Ptr[GtkPrintOperation], Ptr[GtkWidget]], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkWidget], Unit], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintOperationPreview], Ptr[GtkPrintContext], Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkWidget], Ptr[GtkPageSetup], Ptr[GtkPrintSettings], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkPrintOperationClass:
  given _tag: Tag[_GtkPrintOperationClass] = Tag.materializeCStruct13Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr2[Ptr[GtkPrintOperation], GtkPrintOperationResult, Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Ptr[GtkPageSetup], Unit], CFuncPtr3[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Unit], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], CFuncPtr1[Ptr[GtkPrintOperation], Unit], CFuncPtr1[Ptr[GtkPrintOperation], Ptr[GtkWidget]], CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkWidget], Unit], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintOperationPreview], Ptr[GtkPrintContext], Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkWidget], Ptr[GtkPageSetup], Ptr[GtkPrintSettings], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkPrintOperationClass] = scala.scalanative.unsafe.alloc[_GtkPrintOperationClass](1)
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, done : CFuncPtr2[Ptr[GtkPrintOperation], GtkPrintOperationResult, Unit], begin_print : CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], paginate : CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], _root_.sn.gnome.glib.internal.gboolean], request_page_setup : CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Ptr[GtkPageSetup], Unit], draw_page : CFuncPtr3[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], CInt, Unit], end_print : CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkPrintContext], Unit], status_changed : CFuncPtr1[Ptr[GtkPrintOperation], Unit], create_custom_widget : CFuncPtr1[Ptr[GtkPrintOperation], Ptr[GtkWidget]], custom_widget_apply : CFuncPtr2[Ptr[GtkPrintOperation], Ptr[GtkWidget], Unit], preview : CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkPrintOperationPreview], Ptr[GtkPrintContext], Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean], update_custom_widget : CFuncPtr4[Ptr[GtkPrintOperation], Ptr[GtkWidget], Ptr[GtkPageSetup], Ptr[GtkPrintSettings], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkPrintOperationClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).done = done
    (!____ptr).begin_print = begin_print
 ...
 * GtkRecentData: _name: a UTF-8 encoded string, containing the name of the recently used resource to be displayed, or %NULL; : a UTF-8 encoded string, containing a short description of the resource, or %NULL; _type: the MIME type of the resource; _name: the name of the application that is registering this recently used resource; _exec: command line used to launch this resource; may contain the “%f” and “%u” escape characters which will be expanded to the resource file path and URI respectively when the command line is retrieved; : (array zero-terminated=1): a vector of strings containing groups names; applications that have registered it or not.
*/
opaque type _GtkRecentData = CStruct7[Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gboolean]
object _GtkRecentData:
  given _tag: Tag[_GtkRecentData] = Tag.materializeCStruct7Tag[Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[CUnsignedChar], Ptr[Ptr[CUnsignedChar]], _root_.sn.gnome.glib.internal.gboolean]
  def apply()(using Zone): Ptr[_GtkRecentData] = scala.scalanative.unsafe.alloc[_GtkRecentData](1)
  def apply(display_name : Ptr[CUnsignedChar], description : Ptr[CUnsignedChar], mime_type : Ptr[CUnsignedChar], app_name : Ptr[CUnsignedChar], app_exec : Ptr[CUnsignedChar], groups : Ptr[Ptr[CUnsignedChar]], is_private : _root_.sn.gnome.glib.internal.gboolean)(using Zone): Ptr[_GtkRecentData] = 
    val ____ptr = apply()
    (!____ptr).display_name = display_name
    (!____ptr).description = description
    (!____ptr).mime_type = mime_type
...
object _GtkRecentManager:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GtkRecentManagerPrivate])(using Zone): Ptr[_GtkRecentManager] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).priv = priv
    ____ptr
...
object _GtkScaleButtonClass:
  ...
  def apply(parent_class : GtkWidgetClass, value_changed : CFuncPtr2[Ptr[GtkScaleButton], Double, Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkScaleButtonClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).value_changed = value_changed
    (!____ptr).padding = padding
...
object _GtkSizeGroup:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkSizeGroup] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkSorter:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject)(using Zone): Ptr[_GtkSorter] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    ____ptr
...
object _GtkStyleContextClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, changed : CFuncPtr1[Ptr[GtkStyleContext], Unit], _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkStyleContextClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).changed = changed
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
 ...
 * GtkSymbolicPaintableInterface: _symbolic: Snapshot the paintable using the given colors. See `GtkSymbolicPaintable::snapshot_symbolic()` for details. If this function is not implemented, [vfunc.Paintable.snapshot] will be called.
*/
opaque type _GtkSymbolicPaintableInterface = CStruct2[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr6[Ptr[GtkSymbolicPaintable], Ptr[GdkSnapshot], Double, Double, Ptr[GdkRGBA], _root_.sn.gnome.glib.internal.gsize, Unit]]
object _GtkSymbolicPaintableInterface:
  given _tag: Tag[_GtkSymbolicPaintableInterface] = Tag.materializeCStruct2Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr6[Ptr[GtkSymbolicPaintable], Ptr[GdkSnapshot], Double, Double, Ptr[GdkRGBA], _root_.sn.gnome.glib.internal.gsize, Unit]]
  def apply()(using Zone): Ptr[_GtkSymbolicPaintableInterface] = scala.scalanative.unsafe.alloc[_GtkSymbolicPaintableInterface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, snapshot_symbolic : CFuncPtr6[Ptr[GtkSymbolicPaintable], Ptr[GdkSnapshot], Double, Double, Ptr[GdkRGBA], _root_.sn.gnome.glib.internal.gsize, Unit])(using Zone): Ptr[_GtkSymbolicPaintableInterface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).snapshot_symbolic = snapshot_symbolic
    ____ptr
 ...
 * GtkTextBufferClass: _class: The object class structure needs to be the first. _text: The class handler for the `GtkTextBuffer::insert-text` signal. _paintable: The class handler for the `GtkTextBuffer::insert-paintable` signal. _child_anchor: The class handler for the `GtkTextBuffer::insert-child-anchor` signal. _range: The class handler for the `GtkTextBuffer::delete-range` signal. : The class handler for the `GtkTextBuffer::changed` signal. _changed: The class handler for the `GtkTextBuffer::modified-changed` signal. _set: The class handler for the `GtkTextBuffer::mark-set` signal. _deleted: The class handler for the `GtkTextBuffer::mark-deleted` signal. _tag: The class handler for the `GtkTextBuffer::apply-tag` signal. _tag: The class handler for the `GtkTextBuffer::remove-tag` signal. _user_action: The class handler for the `GtkTextBuffer::begin-user-action` signal. _user_action: The class handler for the `GtkTextBuffer::end-user-action` signal. _done: The class handler for the `GtkTextBuffer::paste-done` signal. : The class handler for the `GtkTextBuffer::undo` signal : The class handler for the `GtkTextBuffer::redo` signal
*/
opaque type _GtkTextBufferClass = CStruct20[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
object _GtkTextBufferClass:
  given _tag: Tag[_GtkTextBufferClass] = Tag.materializeCStruct20Tag[_root_.sn.gnome.gobject.internal.GObjectClass, CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[CUnsignedChar], CInt, Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GdkPaintable], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextChildAnchor], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr3[Ptr[GtkTextBuffer], Ptr[GtkTextIter], Ptr[GtkTextMark], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GtkTextMark], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr4[Ptr[GtkTextBuffer], Ptr[GtkTextTag], Ptr[GtkTextIter], Ptr[GtkTextIter], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr2[Ptr[GtkTextBuffer], Ptr[GdkClipboard], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr1[Ptr[GtkTextBuffer], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
...
object _GtkTextChildAnchor:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, segment : _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[_GtkTextChildAnchor] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).segment = segment
    ____ptr
...
object _GtkTextChildAnchorClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkTextChildAnchorClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
...
object _GtkTextIter:
  ...
  def apply(dummy1 : _root_.sn.gnome.glib.internal.gpointer, dummy2 : _root_.sn.gnome.glib.internal.gpointer, dummy3 : CInt, dummy4 : CInt, dummy5 : CInt, dummy6 : CInt, dummy7 : CInt, dummy8 : CInt, dummy9 : _root_.sn.gnome.glib.internal.gpointer, dummy10 : _root_.sn.gnome.glib.internal.gpointer, dummy11 : CInt, dummy12 : CInt, dummy13 : CInt, dummy14 : _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[_GtkTextIter] = 
    val ____ptr = apply()
    (!____ptr).dummy1 = dummy1
    (!____ptr).dummy2 = dummy2
    (!____ptr).dummy3 = dummy3
...
object _GtkTextTagClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkTextTagClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
 ...
 * GtkTextViewClass: _class: The object class structure needs to be the first _cursor: The class handler for the `GtkTextView::move-cursor` keybinding signal.
*/
opaque type _GtkTextViewClass = CStruct15[GtkWidgetClass, CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkTextView], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkTextViewClass:
  given _tag: Tag[_GtkTextViewClass] = Tag.materializeCStruct15Tag[GtkWidgetClass, CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Unit], CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkTextView], Unit], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
  def apply()(using Zone): Ptr[_GtkTextViewClass] = scala.scalanative.unsafe.alloc[_GtkTextViewClass](1)
  def apply(parent_class : GtkWidgetClass, move_cursor : CFuncPtr4[Ptr[GtkTextView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, Unit], set_anchor : CFuncPtr1[Ptr[GtkTextView], Unit], insert_at_cursor : CFuncPtr2[Ptr[GtkTextView], Ptr[CUnsignedChar], Unit], delete_from_cursor : CFuncPtr3[Ptr[GtkTextView], GtkDeleteType, CInt, Unit], backspace : CFuncPtr1[Ptr[GtkTextView], Unit], cut_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], copy_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], paste_clipboard : CFuncPtr1[Ptr[GtkTextView], Unit], toggle_overwrite : CFuncPtr1[Ptr[GtkTextView], Unit], create_buffer : CFuncPtr1[Ptr[GtkTextView], Ptr[GtkTextBuffer]], snapshot_layer : CFuncPtr3[Ptr[GtkTextView], GtkTextViewLayer, Ptr[GtkSnapshot], Unit], extend_selection : CFuncPtr5[Ptr[GtkTextView], GtkTextExtendSelection, Ptr[GtkTextIter], Ptr[GtkTextIter], Ptr[GtkTextIter], _root_.sn.gnome.glib.internal.gboolean], insert_emoji : CFuncPtr1[Ptr[GtkTextView], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkTextViewClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).move_cursor = move_cursor
    (!____ptr).set_anchor = set_anchor
...
object _GtkToggleButtonClass:
  ...
  def apply(parent_class : GtkButtonClass, toggled : CFuncPtr1[Ptr[GtkToggleButton], Unit], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkToggleButtonClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).toggled = toggled
    (!____ptr).padding = padding
 ...
 * GtkTreeDragSourceIface: _draggable: Asks the `GtkTreeDragSource` whether a particular row can be used as the source of a DND operation. _data_get: Asks the `GtkTreeDragSource` to fill in selection_data with a representation of the row at path. _data_delete: Asks the `GtkTreeDragSource` to delete the row at path, because it was moved somewhere else via drag-and-drop.
*/
opaque type _GtkTreeDragSourceIface = CStruct4[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]
object _GtkTreeDragSourceIface:
  given _tag: Tag[_GtkTreeDragSourceIface] = Tag.materializeCStruct4Tag[_root_.sn.gnome.gobject.internal.GTypeInterface, CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[GdkContentProvider]], CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean]]
  def apply()(using Zone): Ptr[_GtkTreeDragSourceIface] = scala.scalanative.unsafe.alloc[_GtkTreeDragSourceIface](1)
  def apply(g_iface : _root_.sn.gnome.gobject.internal.GTypeInterface, row_draggable : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], drag_data_get : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], Ptr[GdkContentProvider]], drag_data_delete : CFuncPtr2[Ptr[GtkTreeDragSource], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean])(using Zone): Ptr[_GtkTreeDragSourceIface] = 
    val ____ptr = apply()
    (!____ptr).g_iface = g_iface
    (!____ptr).row_draggable = row_draggable
    (!____ptr).drag_data_get = drag_data_get
 ...
 * GtkTreeIter: : a unique stamp to catch invalid iterators _data: model-specific data _data2: model-specific data _data3: model-specific data
*/
opaque type _GtkTreeIter = CStruct4[CInt, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer]
object _GtkTreeIter:
  given _tag: Tag[_GtkTreeIter] = Tag.materializeCStruct4Tag[CInt, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer, _root_.sn.gnome.glib.internal.gpointer]
  def apply()(using Zone): Ptr[_GtkTreeIter] = scala.scalanative.unsafe.alloc[_GtkTreeIter](1)
  def apply(stamp : CInt, user_data : _root_.sn.gnome.glib.internal.gpointer, user_data2 : _root_.sn.gnome.glib.internal.gpointer, user_data3 : _root_.sn.gnome.glib.internal.gpointer)(using Zone): Ptr[_GtkTreeIter] = 
    val ____ptr = apply()
    (!____ptr).stamp = stamp
    (!____ptr).user_data = user_data
    (!____ptr).user_data2 = user_data2
...
object _GtkTreeStore:
  ...
  def apply(parent : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GtkTreeStorePrivate])(using Zone): Ptr[_GtkTreeStore] = 
    val ____ptr = apply()
    (!____ptr).parent = parent
    (!____ptr).priv = priv
    ____ptr
...
object _GtkTreeStoreClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkTreeStoreClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).padding = padding
    ____ptr
...
object _GtkTreeViewClass:
  ...
  def apply(parent_class : GtkWidgetClass, row_activated : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreePath], Ptr[GtkTreeViewColumn], Unit], test_expand_row : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], test_collapse_row : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], _root_.sn.gnome.glib.internal.gboolean], row_expanded : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], Unit], row_collapsed : CFuncPtr3[Ptr[GtkTreeView], Ptr[GtkTreeIter], Ptr[GtkTreePath], Unit], columns_changed : CFuncPtr1[Ptr[GtkTreeView], Unit], cursor_changed : CFuncPtr1[Ptr[GtkTreeView], Unit], move_cursor : CFuncPtr5[Ptr[GtkTreeView], GtkMovementStep, CInt, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], select_all : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean], unselect_all : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean], select_cursor_row : CFuncPtr2[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], toggle_cursor_row : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean], expand_collapse_cursor_row : CFuncPtr4[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], select_cursor_parent : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean], start_interactive_search : CFuncPtr1[Ptr[GtkTreeView], _root_.sn.gnome.glib.internal.gboolean], _reserved : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat.Digit2[Nat._1, Nat._6]])(using Zone): Ptr[_GtkTreeViewClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).row_activated = row_activated
    (!____ptr).test_expand_row = test_expand_row
...
object _GtkWidget:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GInitiallyUnowned, priv : Ptr[GtkWidgetPrivate])(using Zone): Ptr[_GtkWidget] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).priv = priv
    ____ptr
...
object _GtkWidgetClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GInitiallyUnownedClass, show : CFuncPtr1[Ptr[GtkWidget], Unit], hide : CFuncPtr1[Ptr[GtkWidget], Unit], map : CFuncPtr1[Ptr[GtkWidget], Unit], unmap : CFuncPtr1[Ptr[GtkWidget], Unit], realize : CFuncPtr1[Ptr[GtkWidget], Unit], unrealize : CFuncPtr1[Ptr[GtkWidget], Unit], root : CFuncPtr1[Ptr[GtkWidget], Unit], unroot : CFuncPtr1[Ptr[GtkWidget], Unit], size_allocate : CFuncPtr4[Ptr[GtkWidget], CInt, CInt, CInt, Unit], state_flags_changed : CFuncPtr2[Ptr[GtkWidget], GtkStateFlags, Unit], direction_changed : CFuncPtr2[Ptr[GtkWidget], GtkTextDirection, Unit], get_request_mode : CFuncPtr1[Ptr[GtkWidget], GtkSizeRequestMode], measure : CFuncPtr7[Ptr[GtkWidget], GtkOrientation, CInt, Ptr[CInt], Ptr[CInt], Ptr[CInt], Ptr[CInt], Unit], mnemonic_activate : CFuncPtr2[Ptr[GtkWidget], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], grab_focus : CFuncPtr1[Ptr[GtkWidget], _root_.sn.gnome.glib.internal.gboolean], focus : CFuncPtr2[Ptr[GtkWidget], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], set_focus_child : CFuncPtr2[Ptr[GtkWidget], Ptr[GtkWidget], Unit], move_focus : CFuncPtr2[Ptr[GtkWidget], GtkDirectionType, Unit], keynav_failed : CFuncPtr2[Ptr[GtkWidget], GtkDirectionType, _root_.sn.gnome.glib.internal.gboolean], query_tooltip : CFuncPtr5[Ptr[GtkWidget], CInt, CInt, _root_.sn.gnome.glib.internal.gboolean, Ptr[GtkTooltip], _root_.sn.gnome.glib.internal.gboolean], compute_expand : CFuncPtr3[Ptr[GtkWidget], Ptr[_root_.sn.gnome.glib.internal.gboolean], Ptr[_root_.sn.gnome.glib.internal.gboolean], Unit], css_changed : CFuncPtr2[Ptr[GtkWidget], Ptr[GtkCssStyleChange], Unit], system_setting_changed : CFuncPtr2[Ptr[GtkWidget], GtkSystemSetting, Unit], snapshot : CFuncPtr2[Ptr[GtkWidget], Ptr[GtkSnapshot], Unit], contains : CFuncPtr3[Ptr[GtkWidget], Double, Double, _root_.sn.gnome.glib.internal.gboolean], priv : Ptr[GtkWidgetClassPrivate], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkWidgetClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).show = show
    (!____ptr).hide = hide
 ...
 * GtkWindowClass: _class: The parent class. _focus: Activates the current focused widget within the window. _default: Activates the default widget for the window. _changed: Signal gets emitted when the set of accelerators or mnemonics that are associated with window changes. _debugging: Class handler for the `GtkWindow::enable-debugging` keybinding signal. _request: Class handler for the `GtkWindow::close-request` signal.
*/
opaque type _GtkWindowClass = CStruct7[GtkWidgetClass, CFuncPtr1[Ptr[GtkWindow], Unit], CFuncPtr1[Ptr[GtkWindow], Unit], CFuncPtr1[Ptr[GtkWindow], Unit], CFuncPtr2[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], CFuncPtr1[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean], CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8]]
object _GtkWindowClass:
  ...
  def apply(parent_class : GtkWidgetClass, activate_focus : CFuncPtr1[Ptr[GtkWindow], Unit], activate_default : CFuncPtr1[Ptr[GtkWindow], Unit], keys_changed : CFuncPtr1[Ptr[GtkWindow], Unit], enable_debugging : CFuncPtr2[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean, _root_.sn.gnome.glib.internal.gboolean], close_request : CFuncPtr1[Ptr[GtkWindow], _root_.sn.gnome.glib.internal.gboolean], padding : CArray[_root_.sn.gnome.glib.internal.gpointer, Nat._8])(using Zone): Ptr[_GtkWindowClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).activate_focus = activate_focus
    (!____ptr).activate_default = activate_default
...
object _GtkWindowGroup:
  ...
  def apply(parent_instance : _root_.sn.gnome.gobject.internal.GObject, priv : Ptr[GtkWindowGroupPrivate])(using Zone): Ptr[_GtkWindowGroup] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).priv = priv
    ____ptr
...
object _GtkWindowGroupClass:
  ...
  def apply(parent_class : _root_.sn.gnome.gobject.internal.GObjectClass, _gtk_reserved1 : CFuncPtr0[Unit], _gtk_reserved2 : CFuncPtr0[Unit], _gtk_reserved3 : CFuncPtr0[Unit], _gtk_reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[_GtkWindowGroupClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr)._gtk_reserved1 = _gtk_reserved1
    (!____ptr)._gtk_reserved2 = _gtk_reserved2
