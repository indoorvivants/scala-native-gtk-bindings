...
*/
opaque type GskRoundedRect = CStruct2[_root_.libgraphene.all.graphene_rect_t, CArray[_root_.libgraphene.all.graphene_size_t, Nat._4]]
object GskRoundedRect:
  given _tag: Tag[GskRoundedRect] = Tag.materializeCStruct2Tag[_root_.libgraphene.all.graphene_rect_t, CArray[_root_.libgraphene.all.graphene_size_t, Nat._4]]
  def apply()(using Zone): Ptr[GskRoundedRect] = scala.scalanative.unsafe.alloc[GskRoundedRect](1)
  def apply(bounds : _root_.libgraphene.all.graphene_rect_t, corner : CArray[_root_.libgraphene.all.graphene_size_t, Nat._4])(using Zone): Ptr[GskRoundedRect] = 
    val ____ptr = apply()
    (!____ptr).bounds = bounds
    (!____ptr).corner = corner
    ____ptr
  extension (struct: GskRoundedRect)
    def bounds : _root_.libgraphene.all.graphene_rect_t = struct._1
    def bounds_=(value: _root_.libgraphene.all.graphene_rect_t): Unit = !struct.at1 = value
    def corner : CArray[_root_.libgraphene.all.graphene_size_t, Nat._4] = struct._2
    def corner_=(value: CArray[_root_.libgraphene.all.graphene_size_t, Nat._4]): Unit = !struct.at2 = value
 ...
 * [bindgen] header: /usr/include/gtk-4.0/gtk/gtkfontchooser.h
*/
opaque type GtkFontChooserIface = CStruct9[_root_.gobject.all.GTypeInterface, CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFamily]], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFace]], CFuncPtr1[Ptr[GtkFontChooser], CInt], CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.glib.all.gpointer, _root_.glib.all.GDestroyNotify, Unit], CFuncPtr2[Ptr[GtkFontChooser], CString, Unit], CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap], Unit], CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap]], CArray[_root_.glib.all.gpointer, Nat.Digit2[Nat._1, Nat._0]]]
object GtkFontChooserIface:
  ...
  def apply(base_iface : _root_.gobject.all.GTypeInterface, get_font_family : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFamily]], get_font_face : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFace]], get_font_size : CFuncPtr1[Ptr[GtkFontChooser], CInt], set_filter_func : CFuncPtr4[Ptr[GtkFontChooser], GtkFontFilterFunc, _root_.glib.all.gpointer, _root_.glib.all.GDestroyNotify, Unit], font_activated : CFuncPtr2[Ptr[GtkFontChooser], CString, Unit], set_font_map : CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap], Unit], get_font_map : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap]], padding : CArray[_root_.glib.all.gpointer, Nat.Digit2[Nat._1, Nat._0]])(using Zone): Ptr[GtkFontChooserIface] = 
    val ____ptr = apply()
    (!____ptr).base_iface = base_iface
  ...
  extension (struct: GtkFontChooserIface)
    def base_iface : _root_.gobject.all.GTypeInterface = struct._1
    def base_iface_=(value: _root_.gobject.all.GTypeInterface): Unit = !struct.at1 = value
    def get_font_family : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFamily]] = struct._2
    def get_font_family_=(value: CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFamily]]): Unit = !struct.at2 = value
    def get_font_face : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFace]] = struct._3
    def get_font_face_=(value: CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontFace]]): Unit = !struct.at3 = value
    ...
    def set_font_map : CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap], Unit] = struct._7
    def set_font_map_=(value: CFuncPtr2[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap], Unit]): Unit = !struct.at7 = value
    def get_font_map : CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap]] = struct._8
    def get_font_map_=(value: CFuncPtr1[Ptr[GtkFontChooser], Ptr[_root_.libpango.all.PangoFontMap]]): Unit = !struct.at8 = value
...
object GtkIMContextClass:
  ...
  extension (struct: GtkIMContextClass)
    ...
    def get_preedit_string: CFuncPtr4[Ptr[GtkIMContext], Ptr[CString], Ptr[Ptr[_root_.libpango.all.PangoAttrList]], Ptr[CInt], Unit] = !struct.at(192).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[CString], Ptr[Ptr[_root_.libpango.all.PangoAttrList]], Ptr[CInt], Unit]]]
    def get_preedit_string_=(value: CFuncPtr4[Ptr[GtkIMContext], Ptr[CString], Ptr[Ptr[_root_.libpango.all.PangoAttrList]], Ptr[CInt], Unit]): Unit = !struct.at(192).asInstanceOf[Ptr[CFuncPtr4[Ptr[GtkIMContext], Ptr[CString], Ptr[Ptr[_root_.libpango.all.PangoAttrList]], Ptr[CInt], Unit]]] = value
 ...
 * [bindgen] header: /usr/include/gtk-4.0/gsk/gskroundedrect.h
*/
opaque type _GskRoundedRect = CStruct2[_root_.libgraphene.all.graphene_rect_t, CArray[_root_.libgraphene.all.graphene_size_t, Nat._4]]
object _GskRoundedRect:
  given _tag: Tag[_GskRoundedRect] = Tag.materializeCStruct2Tag[_root_.libgraphene.all.graphene_rect_t, CArray[_root_.libgraphene.all.graphene_size_t, Nat._4]]
  def apply()(using Zone): Ptr[_GskRoundedRect] = scala.scalanative.unsafe.alloc[_GskRoundedRect](1)
  def apply(bounds : _root_.libgraphene.all.graphene_rect_t, corner : CArray[_root_.libgraphene.all.graphene_size_t, Nat._4])(using Zone): Ptr[_GskRoundedRect] = 
    val ____ptr = apply()
    (!____ptr).bounds = bounds
    (!____ptr).corner = corner
    ____ptr
