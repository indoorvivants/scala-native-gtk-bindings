...
*/
type GdkRectangle = _root_.libcairo.all.cairo_rectangle_int_t
object GdkRectangle: 
  given _tag: Tag[GdkRectangle] = _root_.libcairo.all.cairo_rectangle_int_t._tag
  inline def apply(inline o: _root_.libcairo.all.cairo_rectangle_int_t): GdkRectangle = o
  extension (v: GdkRectangle)
    inline def value: _root_.libcairo.all.cairo_rectangle_int_t = v
...
*/
opaque type GtkDrawingAreaDrawFunc = CFuncPtr5[Ptr[GtkDrawingArea], Ptr[_root_.libcairo.all.cairo_t], CInt, CInt, _root_.glib.all.gpointer, Unit]
object GtkDrawingAreaDrawFunc: 
  given _tag: Tag[GtkDrawingAreaDrawFunc] = Tag.materializeCFuncPtr5[Ptr[GtkDrawingArea], Ptr[_root_.libcairo.all.cairo_t], CInt, CInt, _root_.glib.all.gpointer, Unit]
  inline def apply(inline o: CFuncPtr5[Ptr[GtkDrawingArea], Ptr[_root_.libcairo.all.cairo_t], CInt, CInt, _root_.glib.all.gpointer, Unit]): GtkDrawingAreaDrawFunc = o
  extension (v: GtkDrawingAreaDrawFunc)
    inline def value: CFuncPtr5[Ptr[GtkDrawingArea], Ptr[_root_.libcairo.all.cairo_t], CInt, CInt, _root_.glib.all.gpointer, Unit] = v
...
*/
opaque type GtkFontFilterFunc = CFuncPtr3[Ptr[_root_.libpango.all.PangoFontFamily], Ptr[_root_.libpango.all.PangoFontFace], _root_.glib.all.gpointer, _root_.glib.all.gboolean]
object GtkFontFilterFunc: 
  given _tag: Tag[GtkFontFilterFunc] = Tag.materializeCFuncPtr3[Ptr[_root_.libpango.all.PangoFontFamily], Ptr[_root_.libpango.all.PangoFontFace], _root_.glib.all.gpointer, _root_.glib.all.gboolean]
  inline def apply(inline o: CFuncPtr3[Ptr[_root_.libpango.all.PangoFontFamily], Ptr[_root_.libpango.all.PangoFontFace], _root_.glib.all.gpointer, _root_.glib.all.gboolean]): GtkFontFilterFunc = o
  extension (v: GtkFontFilterFunc)
    inline def value: CFuncPtr3[Ptr[_root_.libpango.all.PangoFontFamily], Ptr[_root_.libpango.all.PangoFontFace], _root_.glib.all.gpointer, _root_.glib.all.gboolean] = v
