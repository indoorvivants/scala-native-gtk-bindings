...
@extern private[internal] def __sn_wrap_sn_gnome_graphene_internal_graphene_simd4f_get(s : Ptr[graphene_simd4f_t], i : CUnsignedInt): Float = extern
...
def graphene_simd4f_get(s : graphene_simd4f_t, i : CUnsignedInt)(using Zone): Float = 
  val __ptr_0: Ptr[graphene_simd4f_t] = alloc[graphene_simd4f_t](1)
  !(__ptr_0 + 0) = s
  __sn_wrap_sn_gnome_graphene_internal_graphene_simd4f_get((__ptr_0 + 0), i)

/**
*/
def graphene_simd4f_get(s : Ptr[graphene_simd4f_t], i : CUnsignedInt): Float = 
  __sn_wrap_sn_gnome_graphene_internal_graphene_simd4f_get(s, i)
