...
object GCacheDestroyFunc: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): GCacheDestroyFunc = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object GCacheNewFunc: 
  ...
  inline def fromPtr(ptr: Ptr[Byte] | CVoidPtr): GCacheNewFunc = CFuncPtr.fromPtr(ptr.asInstanceOf[Ptr[Byte]])
...
object guint64: 
  given _tag: Tag[guint64] = Tag.USize
