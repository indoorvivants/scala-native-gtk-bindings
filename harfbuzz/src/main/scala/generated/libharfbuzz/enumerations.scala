...
private[libharfbuzz] trait CEnumU[T](using eq: T =:= UInt):
...
object hb_script_t extends CEnumU[hb_script_t]:
  ...
  val HB_SCRIPT_GARAY = define(1197568609)
  val HB_SCRIPT_GURUNG_KHEMA = define(1198877544)
  val HB_SCRIPT_KIRAT_RAI = define(1265787241)
  val HB_SCRIPT_OL_ONAL = define(1332633967)
  val HB_SCRIPT_SUNUWAR = define(1400204917)
  val HB_SCRIPT_TODHRI = define(1416586354)
  val HB_SCRIPT_TULU_TIGALARI = define(1416983655)
  ...
  inline def getName(inline value: hb_script_t): Option[String] =
    inline value match
      ...
      case HB_SCRIPT_GARAY => Some("HB_SCRIPT_GARAY")
      case HB_SCRIPT_GURUNG_KHEMA => Some("HB_SCRIPT_GURUNG_KHEMA")
      case HB_SCRIPT_KIRAT_RAI => Some("HB_SCRIPT_KIRAT_RAI")
      case HB_SCRIPT_OL_ONAL => Some("HB_SCRIPT_OL_ONAL")
      case HB_SCRIPT_SUNUWAR => Some("HB_SCRIPT_SUNUWAR")
      case HB_SCRIPT_TODHRI => Some("HB_SCRIPT_TODHRI")
      case HB_SCRIPT_TULU_TIGALARI => Some("HB_SCRIPT_TULU_TIGALARI")
