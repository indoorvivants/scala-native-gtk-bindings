...
object GCClosure:
  given _tag: Tag[GCClosure] = Tag.materializeCStruct2Tag[GClosure, _root_.glib.all.gpointer]
  def apply()(using Zone): Ptr[GCClosure] = scala.scalanative.unsafe.alloc[GCClosure](1)
  def apply(closure : GClosure, callback : _root_.glib.all.gpointer)(using Zone): Ptr[GCClosure] = 
    val ____ptr = apply()
  ...
  extension (struct: GCClosure)
    ...
    def callback : _root_.glib.all.gpointer = struct._2
    def callback_=(value: _root_.glib.all.gpointer): Unit = !struct.at2 = value
...
object GClosure:
  given _tag: Tag[GClosure] = Tag.materializeCStruct13Tag[_root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, CFuncPtr6[Ptr[Byte], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit], _root_.glib.all.gpointer, Ptr[Byte]]
  def apply()(using Zone): Ptr[GClosure] = scala.scalanative.unsafe.alloc[GClosure](1)
  def apply(ref_count : _root_.glib.all.guint, meta_marshal_nouse : _root_.glib.all.guint, n_guards : _root_.glib.all.guint, n_fnotifiers : _root_.glib.all.guint, n_inotifiers : _root_.glib.all.guint, in_inotify : _root_.glib.all.guint, floating : _root_.glib.all.guint, derivative_flag : _root_.glib.all.guint, in_marshal : _root_.glib.all.guint, is_invalid : _root_.glib.all.guint, marshal : CFuncPtr6[Ptr[GClosure], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit], data : _root_.glib.all.gpointer, notifiers : Ptr[GClosureNotifyData])(using Zone): Ptr[GClosure] = 
    val ____ptr = apply()
  ...
  extension (struct: GClosure)
    ...
    def meta_marshal_nouse : _root_.glib.all.guint = struct._2
    def meta_marshal_nouse_=(value: _root_.glib.all.guint): Unit = !struct.at2 = value
    def n_guards : _root_.glib.all.guint = struct._3
    def n_guards_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
    def n_fnotifiers : _root_.glib.all.guint = struct._4
    def n_fnotifiers_=(value: _root_.glib.all.guint): Unit = !struct.at4 = value
    def n_inotifiers : _root_.glib.all.guint = struct._5
    def n_inotifiers_=(value: _root_.glib.all.guint): Unit = !struct.at5 = value
    def in_inotify : _root_.glib.all.guint = struct._6
    def in_inotify_=(value: _root_.glib.all.guint): Unit = !struct.at6 = value
    def floating : _root_.glib.all.guint = struct._7
    def floating_=(value: _root_.glib.all.guint): Unit = !struct.at7 = value
    def derivative_flag : _root_.glib.all.guint = struct._8
    def derivative_flag_=(value: _root_.glib.all.guint): Unit = !struct.at8 = value
    def in_marshal : _root_.glib.all.guint = struct._9
    def in_marshal_=(value: _root_.glib.all.guint): Unit = !struct.at9 = value
    def is_invalid : _root_.glib.all.guint = struct._10
    def is_invalid_=(value: _root_.glib.all.guint): Unit = !struct.at10 = value
    def marshal : CFuncPtr6[Ptr[GClosure], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit] = struct._11.asInstanceOf[CFuncPtr6[Ptr[GClosure], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit]]
    def marshal_=(value: CFuncPtr6[Ptr[GClosure], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit]): Unit = !struct.at11 = value.asInstanceOf[CFuncPtr6[Ptr[Byte], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit]]
    def data : _root_.glib.all.gpointer = struct._12
    def data_=(value: _root_.glib.all.gpointer): Unit = !struct.at12 = value
...
object GClosureNotifyData:
  given _tag: Tag[GClosureNotifyData] = Tag.materializeCStruct2Tag[_root_.glib.all.gpointer, Ptr[Byte]]
  def apply()(using Zone): Ptr[GClosureNotifyData] = scala.scalanative.unsafe.alloc[GClosureNotifyData](1)
  def apply(data : _root_.glib.all.gpointer, _notify : GClosureNotify)(using Zone): Ptr[GClosureNotifyData] = 
    val ____ptr = apply()
    (!____ptr).data = data
...
object GEnumClass:
  given _tag: Tag[GEnumClass] = Tag.materializeCStruct5Tag[GTypeClass, _root_.glib.all.gint, _root_.glib.all.gint, _root_.glib.all.guint, Ptr[GEnumValue]]
  def apply()(using Zone): Ptr[GEnumClass] = scala.scalanative.unsafe.alloc[GEnumClass](1)
  def apply(g_type_class : GTypeClass, minimum : _root_.glib.all.gint, maximum : _root_.glib.all.gint, n_values : _root_.glib.all.guint, values : Ptr[GEnumValue])(using Zone): Ptr[GEnumClass] = 
    val ____ptr = apply()
  ...
  extension (struct: GEnumClass)
    ...
    def minimum : _root_.glib.all.gint = struct._2
    def minimum_=(value: _root_.glib.all.gint): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gint = struct._3
    def maximum_=(value: _root_.glib.all.gint): Unit = !struct.at3 = value
    def n_values : _root_.glib.all.guint = struct._4
    def n_values_=(value: _root_.glib.all.guint): Unit = !struct.at4 = value
...
object GEnumValue:
  given _tag: Tag[GEnumValue] = Tag.materializeCStruct3Tag[_root_.glib.all.gint, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[GEnumValue] = scala.scalanative.unsafe.alloc[GEnumValue](1)
  def apply(value : _root_.glib.all.gint, value_name : Ptr[_root_.glib.all.gchar], value_nick : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[GEnumValue] = 
    val ____ptr = apply()
    (!____ptr).value = value
  ...
  extension (struct: GEnumValue)
    def value : _root_.glib.all.gint = struct._1
    def value_=(value: _root_.glib.all.gint): Unit = !struct.at1 = value
    def value_name : Ptr[_root_.glib.all.gchar] = struct._2
    def value_name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    def value_nick : Ptr[_root_.glib.all.gchar] = struct._3
    def value_nick_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at3 = value
...
object GFlagsClass:
  given _tag: Tag[GFlagsClass] = Tag.materializeCStruct4Tag[GTypeClass, _root_.glib.all.guint, _root_.glib.all.guint, Ptr[GFlagsValue]]
  def apply()(using Zone): Ptr[GFlagsClass] = scala.scalanative.unsafe.alloc[GFlagsClass](1)
  def apply(g_type_class : GTypeClass, mask : _root_.glib.all.guint, n_values : _root_.glib.all.guint, values : Ptr[GFlagsValue])(using Zone): Ptr[GFlagsClass] = 
    val ____ptr = apply()
    (!____ptr).g_type_class = g_type_class
    (!____ptr).mask = mask
    (!____ptr).n_values = n_values
  ...
  extension (struct: GFlagsClass)
    def g_type_class : GTypeClass = struct._1
    def g_type_class_=(value: GTypeClass): Unit = !struct.at1 = value
    def mask : _root_.glib.all.guint = struct._2
    def mask_=(value: _root_.glib.all.guint): Unit = !struct.at2 = value
    def n_values : _root_.glib.all.guint = struct._3
    def n_values_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
...
object GFlagsValue:
  given _tag: Tag[GFlagsValue] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[GFlagsValue] = scala.scalanative.unsafe.alloc[GFlagsValue](1)
  def apply(value : _root_.glib.all.guint, value_name : Ptr[_root_.glib.all.gchar], value_nick : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[GFlagsValue] = 
    val ____ptr = apply()
    (!____ptr).value = value
    (!____ptr).value_name = value_name
    (!____ptr).value_nick = value_nick
  ...
  extension (struct: GFlagsValue)
    def value : _root_.glib.all.guint = struct._1
    def value_=(value: _root_.glib.all.guint): Unit = !struct.at1 = value
    def value_name : Ptr[_root_.glib.all.gchar] = struct._2
    def value_name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    def value_nick : Ptr[_root_.glib.all.gchar] = struct._3
    def value_nick_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at3 = value
...
object GInitiallyUnowned:
  given _tag: Tag[GInitiallyUnowned] = Tag.materializeCStruct3Tag[GTypeInstance, _root_.glib.all.guint, Ptr[_root_.glib.all.GData]]
  def apply()(using Zone): Ptr[GInitiallyUnowned] = scala.scalanative.unsafe.alloc[GInitiallyUnowned](1)
  def apply(g_type_instance : GTypeInstance, ref_count : _root_.glib.all.guint, qdata : Ptr[_root_.glib.all.GData])(using Zone): Ptr[GInitiallyUnowned] = 
    val ____ptr = apply()
  ...
  extension (struct: GInitiallyUnowned)
    ...
    def ref_count : _root_.glib.all.guint = struct._2
    def ref_count_=(value: _root_.glib.all.guint): Unit = !struct.at2 = value
    def qdata : Ptr[_root_.glib.all.GData] = struct._3
    def qdata_=(value: Ptr[_root_.glib.all.GData]): Unit = !struct.at3 = value
...
object GInitiallyUnownedClass:
  ...
  extension (struct: GInitiallyUnownedClass)
    def g_type_class : GTypeClass = struct._1
    def g_type_class_=(value: GTypeClass): Unit = !struct.at1 = value
    def construct_properties : Ptr[_root_.glib.all.GSList] = struct._2.asInstanceOf[Ptr[_root_.glib.all.GSList]]
    def construct_properties_=(value: Ptr[_root_.glib.all.GSList]): Unit = !struct.at2 = value.asInstanceOf[Ptr[Byte]]
    def constructor : CFuncPtr3[GType, _root_.glib.all.guint, Ptr[GObjectConstructParam], Ptr[GObject]] = struct._3
    def constructor_=(value: CFuncPtr3[GType, _root_.glib.all.guint, Ptr[GObjectConstructParam], Ptr[GObject]]): Unit = !struct.at3 = value
    def set_property : CFuncPtr4[Ptr[GObject], _root_.glib.all.guint, Ptr[GValue], Ptr[GParamSpec], Unit] = struct._4
    def set_property_=(value: CFuncPtr4[Ptr[GObject], _root_.glib.all.guint, Ptr[GValue], Ptr[GParamSpec], Unit]): Unit = !struct.at4 = value
    def get_property : CFuncPtr4[Ptr[GObject], _root_.glib.all.guint, Ptr[GValue], Ptr[GParamSpec], Unit] = struct._5
    def get_property_=(value: CFuncPtr4[Ptr[GObject], _root_.glib.all.guint, Ptr[GValue], Ptr[GParamSpec], Unit]): Unit = !struct.at5 = value
    ...
    def dispatch_properties_changed : CFuncPtr3[Ptr[GObject], _root_.glib.all.guint, Ptr[Ptr[GParamSpec]], Unit] = struct._8
    def dispatch_properties_changed_=(value: CFuncPtr3[Ptr[GObject], _root_.glib.all.guint, Ptr[Ptr[GParamSpec]], Unit]): Unit = !struct.at8 = value
...
object GInterfaceInfo:
  given _tag: Tag[GInterfaceInfo] = Tag.materializeCStruct3Tag[GInterfaceInitFunc, GInterfaceFinalizeFunc, _root_.glib.all.gpointer]
  def apply()(using Zone): Ptr[GInterfaceInfo] = scala.scalanative.unsafe.alloc[GInterfaceInfo](1)
  def apply(interface_init : GInterfaceInitFunc, interface_finalize : GInterfaceFinalizeFunc, interface_data : _root_.glib.all.gpointer)(using Zone): Ptr[GInterfaceInfo] = 
    val ____ptr = apply()
  ...
  extension (struct: GInterfaceInfo)
    ...
    def interface_data : _root_.glib.all.gpointer = struct._3
    def interface_data_=(value: _root_.glib.all.gpointer): Unit = !struct.at3 = value
...
object GObject:
  given _tag: Tag[GObject] = Tag.materializeCStruct3Tag[GTypeInstance, _root_.glib.all.guint, Ptr[_root_.glib.all.GData]]
  def apply()(using Zone): Ptr[GObject] = scala.scalanative.unsafe.alloc[GObject](1)
  def apply(g_type_instance : GTypeInstance, ref_count : _root_.glib.all.guint, qdata : Ptr[_root_.glib.all.GData])(using Zone): Ptr[GObject] = 
    val ____ptr = apply()
    (!____ptr).g_type_instance = g_type_instance
    (!____ptr).ref_count = ref_count
    (!____ptr).qdata = qdata
...
object GParamSpec:
  given _tag: Tag[GParamSpec] = Tag.materializeCStruct10Tag[GTypeInstance, Ptr[_root_.glib.all.gchar], GParamFlags, GType, GType, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.GData], _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GParamSpec] = scala.scalanative.unsafe.alloc[GParamSpec](1)
  def apply(g_type_instance : GTypeInstance, name : Ptr[_root_.glib.all.gchar], flags : GParamFlags, value_type : GType, owner_type : GType, _nick : Ptr[_root_.glib.all.gchar], _blurb : Ptr[_root_.glib.all.gchar], qdata : Ptr[_root_.glib.all.GData], ref_count : _root_.glib.all.guint, param_id : _root_.glib.all.guint)(using Zone): Ptr[GParamSpec] = 
    val ____ptr = apply()
    (!____ptr).g_type_instance = g_type_instance
    (!____ptr).name = name
    (!____ptr).flags = flags
  ...
  extension (struct: GParamSpec)
    def g_type_instance : GTypeInstance = struct._1
    def g_type_instance_=(value: GTypeInstance): Unit = !struct.at1 = value
    def name : Ptr[_root_.glib.all.gchar] = struct._2
    def name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    ...
    def _nick : Ptr[_root_.glib.all.gchar] = struct._6
    def _nick_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at6 = value
    def _blurb : Ptr[_root_.glib.all.gchar] = struct._7
    def _blurb_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at7 = value
    def qdata : Ptr[_root_.glib.all.GData] = struct._8
    def qdata_=(value: Ptr[_root_.glib.all.GData]): Unit = !struct.at8 = value
    def ref_count : _root_.glib.all.guint = struct._9
    def ref_count_=(value: _root_.glib.all.guint): Unit = !struct.at9 = value
    def param_id : _root_.glib.all.guint = struct._10
    def param_id_=(value: _root_.glib.all.guint): Unit = !struct.at10 = value
...
object GParamSpecBoolean:
  given _tag: Tag[GParamSpecBoolean] = Tag.materializeCStruct2Tag[GParamSpec, _root_.glib.all.gboolean]
  def apply()(using Zone): Ptr[GParamSpecBoolean] = scala.scalanative.unsafe.alloc[GParamSpecBoolean](1)
  def apply(parent_instance : GParamSpec, default_value : _root_.glib.all.gboolean)(using Zone): Ptr[GParamSpecBoolean] = 
    val ____ptr = apply()
  ...
  extension (struct: GParamSpecBoolean)
    ...
    def default_value : _root_.glib.all.gboolean = struct._2
    def default_value_=(value: _root_.glib.all.gboolean): Unit = !struct.at2 = value
...
object GParamSpecChar:
  given _tag: Tag[GParamSpecChar] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint8, _root_.glib.all.gint8, _root_.glib.all.gint8]
  def apply()(using Zone): Ptr[GParamSpecChar] = scala.scalanative.unsafe.alloc[GParamSpecChar](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint8, maximum : _root_.glib.all.gint8, default_value : _root_.glib.all.gint8)(using Zone): Ptr[GParamSpecChar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecChar)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.gint8 = struct._2
    def minimum_=(value: _root_.glib.all.gint8): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gint8 = struct._3
    def maximum_=(value: _root_.glib.all.gint8): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gint8 = struct._4
...
object GParamSpecClass:
  ...
  extension (struct: GParamSpecClass)
    ...
    def value_validate : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], _root_.glib.all.gboolean] = struct._5
...
object GParamSpecDouble:
  given _tag: Tag[GParamSpecDouble] = Tag.materializeCStruct5Tag[GParamSpec, _root_.glib.all.gdouble, _root_.glib.all.gdouble, _root_.glib.all.gdouble, _root_.glib.all.gdouble]
  def apply()(using Zone): Ptr[GParamSpecDouble] = scala.scalanative.unsafe.alloc[GParamSpecDouble](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gdouble, maximum : _root_.glib.all.gdouble, default_value : _root_.glib.all.gdouble, epsilon : _root_.glib.all.gdouble)(using Zone): Ptr[GParamSpecDouble] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecDouble)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.gdouble = struct._2
    def minimum_=(value: _root_.glib.all.gdouble): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gdouble = struct._3
    def maximum_=(value: _root_.glib.all.gdouble): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gdouble = struct._4
    def default_value_=(value: _root_.glib.all.gdouble): Unit = !struct.at4 = value
    def epsilon : _root_.glib.all.gdouble = struct._5
    def epsilon_=(value: _root_.glib.all.gdouble): Unit = !struct.at5 = value
...
object GParamSpecEnum:
  given _tag: Tag[GParamSpecEnum] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GEnumClass], _root_.glib.all.gint]
  def apply()(using Zone): Ptr[GParamSpecEnum] = scala.scalanative.unsafe.alloc[GParamSpecEnum](1)
  def apply(parent_instance : GParamSpec, enum_class : Ptr[GEnumClass], default_value : _root_.glib.all.gint)(using Zone): Ptr[GParamSpecEnum] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
  ...
  extension (struct: GParamSpecEnum)
    ...
    def default_value : _root_.glib.all.gint = struct._3
    def default_value_=(value: _root_.glib.all.gint): Unit = !struct.at3 = value
...
object GParamSpecFlags:
  given _tag: Tag[GParamSpecFlags] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GFlagsClass], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GParamSpecFlags] = scala.scalanative.unsafe.alloc[GParamSpecFlags](1)
  def apply(parent_instance : GParamSpec, flags_class : Ptr[GFlagsClass], default_value : _root_.glib.all.guint)(using Zone): Ptr[GParamSpecFlags] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
  ...
  extension (struct: GParamSpecFlags)
    ...
    def default_value : _root_.glib.all.guint = struct._3
    def default_value_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
...
object GParamSpecFloat:
  given _tag: Tag[GParamSpecFloat] = Tag.materializeCStruct5Tag[GParamSpec, _root_.glib.all.gfloat, _root_.glib.all.gfloat, _root_.glib.all.gfloat, _root_.glib.all.gfloat]
  def apply()(using Zone): Ptr[GParamSpecFloat] = scala.scalanative.unsafe.alloc[GParamSpecFloat](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gfloat, maximum : _root_.glib.all.gfloat, default_value : _root_.glib.all.gfloat, epsilon : _root_.glib.all.gfloat)(using Zone): Ptr[GParamSpecFloat] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecFloat)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.gfloat = struct._2
    def minimum_=(value: _root_.glib.all.gfloat): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gfloat = struct._3
    def maximum_=(value: _root_.glib.all.gfloat): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gfloat = struct._4
    def default_value_=(value: _root_.glib.all.gfloat): Unit = !struct.at4 = value
    def epsilon : _root_.glib.all.gfloat = struct._5
    def epsilon_=(value: _root_.glib.all.gfloat): Unit = !struct.at5 = value
...
object GParamSpecInt:
  given _tag: Tag[GParamSpecInt] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint, _root_.glib.all.gint, _root_.glib.all.gint]
  def apply()(using Zone): Ptr[GParamSpecInt] = scala.scalanative.unsafe.alloc[GParamSpecInt](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint, maximum : _root_.glib.all.gint, default_value : _root_.glib.all.gint)(using Zone): Ptr[GParamSpecInt] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecInt)
    ...
    def maximum : _root_.glib.all.gint = struct._3
    def maximum_=(value: _root_.glib.all.gint): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gint = struct._4
    def default_value_=(value: _root_.glib.all.gint): Unit = !struct.at4 = value
...
object GParamSpecInt64:
  given _tag: Tag[GParamSpecInt64] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint64, _root_.glib.all.gint64, _root_.glib.all.gint64]
  def apply()(using Zone): Ptr[GParamSpecInt64] = scala.scalanative.unsafe.alloc[GParamSpecInt64](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint64, maximum : _root_.glib.all.gint64, default_value : _root_.glib.all.gint64)(using Zone): Ptr[GParamSpecInt64] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecInt64)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.gint64 = struct._2
    def minimum_=(value: _root_.glib.all.gint64): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gint64 = struct._3
    def maximum_=(value: _root_.glib.all.gint64): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gint64 = struct._4
    def default_value_=(value: _root_.glib.all.gint64): Unit = !struct.at4 = value
...
object GParamSpecLong:
  given _tag: Tag[GParamSpecLong] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.glong, _root_.glib.all.glong, _root_.glib.all.glong]
  def apply()(using Zone): Ptr[GParamSpecLong] = scala.scalanative.unsafe.alloc[GParamSpecLong](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.glong, maximum : _root_.glib.all.glong, default_value : _root_.glib.all.glong)(using Zone): Ptr[GParamSpecLong] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecLong)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.glong = struct._2
    def minimum_=(value: _root_.glib.all.glong): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.glong = struct._3
    def maximum_=(value: _root_.glib.all.glong): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.glong = struct._4
    def default_value_=(value: _root_.glib.all.glong): Unit = !struct.at4 = value
...
object GParamSpecString:
  given _tag: Tag[GParamSpecString] = Tag.materializeCStruct7Tag[GParamSpec, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], _root_.glib.all.gchar, _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GParamSpecString] = scala.scalanative.unsafe.alloc[GParamSpecString](1)
  def apply(parent_instance : GParamSpec, default_value : Ptr[_root_.glib.all.gchar], cset_first : Ptr[_root_.glib.all.gchar], cset_nth : Ptr[_root_.glib.all.gchar], substitutor : _root_.glib.all.gchar, null_fold_if_empty : _root_.glib.all.guint, ensure_non_null : _root_.glib.all.guint)(using Zone): Ptr[GParamSpecString] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).default_value = default_value
  ...
  extension (struct: GParamSpecString)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def default_value : Ptr[_root_.glib.all.gchar] = struct._2
    def default_value_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    def cset_first : Ptr[_root_.glib.all.gchar] = struct._3
    def cset_first_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at3 = value
    def cset_nth : Ptr[_root_.glib.all.gchar] = struct._4
    def cset_nth_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at4 = value
    def substitutor : _root_.glib.all.gchar = struct._5
    def substitutor_=(value: _root_.glib.all.gchar): Unit = !struct.at5 = value
    def null_fold_if_empty : _root_.glib.all.guint = struct._6
    def null_fold_if_empty_=(value: _root_.glib.all.guint): Unit = !struct.at6 = value
    def ensure_non_null : _root_.glib.all.guint = struct._7
    def ensure_non_null_=(value: _root_.glib.all.guint): Unit = !struct.at7 = value
...
object GParamSpecTypeInfo:
  ...
  def apply(instance_size : _root_.glib.all.guint16, n_preallocs : _root_.glib.all.guint16, instance_init : CFuncPtr1[Ptr[GParamSpec], Unit], value_type : GType, finalize : CFuncPtr1[Ptr[GParamSpec], Unit], value_set_default : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], Unit], value_validate : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], _root_.glib.all.gboolean], values_cmp : CFuncPtr3[Ptr[GParamSpec], Ptr[GValue], Ptr[GValue], _root_.glib.all.gint])(using Zone): Ptr[GParamSpecTypeInfo] = 
    val ____ptr = apply()
  ...
  extension (struct: GParamSpecTypeInfo)
    def instance_size : _root_.glib.all.guint16 = struct._1
    def instance_size_=(value: _root_.glib.all.guint16): Unit = !struct.at1 = value
    def n_preallocs : _root_.glib.all.guint16 = struct._2
    def n_preallocs_=(value: _root_.glib.all.guint16): Unit = !struct.at2 = value
    ...
    def value_validate : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], _root_.glib.all.gboolean] = struct._7
    def value_validate_=(value: CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], _root_.glib.all.gboolean]): Unit = !struct.at7 = value
    def values_cmp : CFuncPtr3[Ptr[GParamSpec], Ptr[GValue], Ptr[GValue], _root_.glib.all.gint] = struct._8
    def values_cmp_=(value: CFuncPtr3[Ptr[GParamSpec], Ptr[GValue], Ptr[GValue], _root_.glib.all.gint]): Unit = !struct.at8 = value
...
object GParamSpecUChar:
  given _tag: Tag[GParamSpecUChar] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint8, _root_.glib.all.guint8, _root_.glib.all.guint8]
  def apply()(using Zone): Ptr[GParamSpecUChar] = scala.scalanative.unsafe.alloc[GParamSpecUChar](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint8, maximum : _root_.glib.all.guint8, default_value : _root_.glib.all.guint8)(using Zone): Ptr[GParamSpecUChar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecUChar)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.guint8 = struct._2
    def minimum_=(value: _root_.glib.all.guint8): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.guint8 = struct._3
    def maximum_=(value: _root_.glib.all.guint8): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.guint8 = struct._4
    def default_value_=(value: _root_.glib.all.guint8): Unit = !struct.at4 = value
...
object GParamSpecUInt:
  given _tag: Tag[GParamSpecUInt] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GParamSpecUInt] = scala.scalanative.unsafe.alloc[GParamSpecUInt](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint, maximum : _root_.glib.all.guint, default_value : _root_.glib.all.guint)(using Zone): Ptr[GParamSpecUInt] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecUInt)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.guint = struct._2
    def minimum_=(value: _root_.glib.all.guint): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.guint = struct._3
    def maximum_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.guint = struct._4
    def default_value_=(value: _root_.glib.all.guint): Unit = !struct.at4 = value
...
object GParamSpecUInt64:
  given _tag: Tag[GParamSpecUInt64] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint64, _root_.glib.all.guint64, _root_.glib.all.guint64]
  def apply()(using Zone): Ptr[GParamSpecUInt64] = scala.scalanative.unsafe.alloc[GParamSpecUInt64](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint64, maximum : _root_.glib.all.guint64, default_value : _root_.glib.all.guint64)(using Zone): Ptr[GParamSpecUInt64] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecUInt64)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.guint64 = struct._2
    def minimum_=(value: _root_.glib.all.guint64): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.guint64 = struct._3
    def maximum_=(value: _root_.glib.all.guint64): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.guint64 = struct._4
    def default_value_=(value: _root_.glib.all.guint64): Unit = !struct.at4 = value
...
object GParamSpecULong:
  given _tag: Tag[GParamSpecULong] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gulong, _root_.glib.all.gulong, _root_.glib.all.gulong]
  def apply()(using Zone): Ptr[GParamSpecULong] = scala.scalanative.unsafe.alloc[GParamSpecULong](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gulong, maximum : _root_.glib.all.gulong, default_value : _root_.glib.all.gulong)(using Zone): Ptr[GParamSpecULong] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
  ...
  extension (struct: GParamSpecULong)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def minimum : _root_.glib.all.gulong = struct._2
    def minimum_=(value: _root_.glib.all.gulong): Unit = !struct.at2 = value
    def maximum : _root_.glib.all.gulong = struct._3
    def maximum_=(value: _root_.glib.all.gulong): Unit = !struct.at3 = value
    def default_value : _root_.glib.all.gulong = struct._4
    def default_value_=(value: _root_.glib.all.gulong): Unit = !struct.at4 = value
...
object GParamSpecUnichar:
  given _tag: Tag[GParamSpecUnichar] = Tag.materializeCStruct2Tag[GParamSpec, _root_.glib.all.gunichar]
  def apply()(using Zone): Ptr[GParamSpecUnichar] = scala.scalanative.unsafe.alloc[GParamSpecUnichar](1)
  def apply(parent_instance : GParamSpec, default_value : _root_.glib.all.gunichar)(using Zone): Ptr[GParamSpecUnichar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).default_value = default_value
    ____ptr
  extension (struct: GParamSpecUnichar)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def default_value : _root_.glib.all.gunichar = struct._2
    def default_value_=(value: _root_.glib.all.gunichar): Unit = !struct.at2 = value
...
object GParamSpecValueArray:
  given _tag: Tag[GParamSpecValueArray] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GParamSpec], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GParamSpecValueArray] = scala.scalanative.unsafe.alloc[GParamSpecValueArray](1)
  def apply(parent_instance : GParamSpec, element_spec : Ptr[GParamSpec], fixed_n_elements : _root_.glib.all.guint)(using Zone): Ptr[GParamSpecValueArray] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
  ...
  extension (struct: GParamSpecValueArray)
    ...
    def fixed_n_elements : _root_.glib.all.guint = struct._3
    def fixed_n_elements_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
...
object GParamSpecVariant:
  given _tag: Tag[GParamSpecVariant] = Tag.materializeCStruct4Tag[GParamSpec, Ptr[_root_.glib.all.GVariantType], Ptr[_root_.glib.all.GVariant], CArray[_root_.glib.all.gpointer, Nat._4]]
  def apply()(using Zone): Ptr[GParamSpecVariant] = scala.scalanative.unsafe.alloc[GParamSpecVariant](1)
  def apply(parent_instance : GParamSpec, `type` : Ptr[_root_.glib.all.GVariantType], default_value : Ptr[_root_.glib.all.GVariant], padding : CArray[_root_.glib.all.gpointer, Nat._4])(using Zone): Ptr[GParamSpecVariant] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).`type` = `type`
    (!____ptr).default_value = default_value
  ...
  extension (struct: GParamSpecVariant)
    def parent_instance : GParamSpec = struct._1
    def parent_instance_=(value: GParamSpec): Unit = !struct.at1 = value
    def `type` : Ptr[_root_.glib.all.GVariantType] = struct._2
    def type_=(value: Ptr[_root_.glib.all.GVariantType]): Unit = !struct.at2 = value
    def default_value : Ptr[_root_.glib.all.GVariant] = struct._3
    def default_value_=(value: Ptr[_root_.glib.all.GVariant]): Unit = !struct.at3 = value
    def padding : CArray[_root_.glib.all.gpointer, Nat._4] = struct._4
    def padding_=(value: CArray[_root_.glib.all.gpointer, Nat._4]): Unit = !struct.at4 = value
...
object GParameter:
  given _tag: Tag[GParameter] = Tag.materializeCStruct2Tag[Ptr[_root_.glib.all.gchar], GValue]
  def apply()(using Zone): Ptr[GParameter] = scala.scalanative.unsafe.alloc[GParameter](1)
  def apply(name : Ptr[_root_.glib.all.gchar], value : GValue)(using Zone): Ptr[GParameter] = 
    val ____ptr = apply()
    (!____ptr).name = name
    (!____ptr).value = value
    ____ptr
  extension (struct: GParameter)
    def name : Ptr[_root_.glib.all.gchar] = struct._1
    def name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at1 = value
...
object GSignalInvocationHint:
  given _tag: Tag[GSignalInvocationHint] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, _root_.glib.all.GQuark, GSignalFlags]
  def apply()(using Zone): Ptr[GSignalInvocationHint] = scala.scalanative.unsafe.alloc[GSignalInvocationHint](1)
  def apply(signal_id : _root_.glib.all.guint, detail : _root_.glib.all.GQuark, run_type : GSignalFlags)(using Zone): Ptr[GSignalInvocationHint] = 
    val ____ptr = apply()
  ...
  extension (struct: GSignalInvocationHint)
    def signal_id : _root_.glib.all.guint = struct._1
    def signal_id_=(value: _root_.glib.all.guint): Unit = !struct.at1 = value
    def detail : _root_.glib.all.GQuark = struct._2
    def detail_=(value: _root_.glib.all.GQuark): Unit = !struct.at2 = value
...
object GSignalQuery:
  given _tag: Tag[GSignalQuery] = Tag.materializeCStruct7Tag[_root_.glib.all.guint, Ptr[_root_.glib.all.gchar], GType, GSignalFlags, GType, _root_.glib.all.guint, Ptr[GType]]
  def apply()(using Zone): Ptr[GSignalQuery] = scala.scalanative.unsafe.alloc[GSignalQuery](1)
  def apply(signal_id : _root_.glib.all.guint, signal_name : Ptr[_root_.glib.all.gchar], itype : GType, signal_flags : GSignalFlags, return_type : GType, n_params : _root_.glib.all.guint, param_types : Ptr[GType])(using Zone): Ptr[GSignalQuery] = 
    val ____ptr = apply()
    (!____ptr).signal_id = signal_id
  ...
  extension (struct: GSignalQuery)
    def signal_id : _root_.glib.all.guint = struct._1
    def signal_id_=(value: _root_.glib.all.guint): Unit = !struct.at1 = value
    def signal_name : Ptr[_root_.glib.all.gchar] = struct._2
    def signal_name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    ...
    def n_params : _root_.glib.all.guint = struct._6
    def n_params_=(value: _root_.glib.all.guint): Unit = !struct.at6 = value
...
object GTypeInfo:
  given _tag: Tag[GTypeInfo] = Tag.materializeCStruct10Tag[_root_.glib.all.guint16, GBaseInitFunc, GBaseFinalizeFunc, GClassInitFunc, GClassFinalizeFunc, _root_.glib.all.gconstpointer, _root_.glib.all.guint16, _root_.glib.all.guint16, GInstanceInitFunc, Ptr[GTypeValueTable]]
  def apply()(using Zone): Ptr[GTypeInfo] = scala.scalanative.unsafe.alloc[GTypeInfo](1)
  def apply(class_size : _root_.glib.all.guint16, base_init : GBaseInitFunc, base_finalize : GBaseFinalizeFunc, class_init : GClassInitFunc, class_finalize : GClassFinalizeFunc, class_data : _root_.glib.all.gconstpointer, instance_size : _root_.glib.all.guint16, n_preallocs : _root_.glib.all.guint16, instance_init : GInstanceInitFunc, value_table : Ptr[GTypeValueTable])(using Zone): Ptr[GTypeInfo] = 
    val ____ptr = apply()
  ...
  extension (struct: GTypeInfo)
    def class_size : _root_.glib.all.guint16 = struct._1
    def class_size_=(value: _root_.glib.all.guint16): Unit = !struct.at1 = value
    ...
    def class_data : _root_.glib.all.gconstpointer = struct._6
    def class_data_=(value: _root_.glib.all.gconstpointer): Unit = !struct.at6 = value
    def instance_size : _root_.glib.all.guint16 = struct._7
    def instance_size_=(value: _root_.glib.all.guint16): Unit = !struct.at7 = value
    def n_preallocs : _root_.glib.all.guint16 = struct._8
    def n_preallocs_=(value: _root_.glib.all.guint16): Unit = !struct.at8 = value
...
object GTypeModule:
  given _tag: Tag[GTypeModule] = Tag.materializeCStruct5Tag[GObject, _root_.glib.all.guint, Ptr[Byte], Ptr[Byte], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[GTypeModule] = scala.scalanative.unsafe.alloc[GTypeModule](1)
  def apply(parent_instance : GObject, use_count : _root_.glib.all.guint, type_infos : Ptr[_root_.glib.all.GSList], interface_infos : Ptr[_root_.glib.all.GSList], name : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[GTypeModule] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
  ...
  extension (struct: GTypeModule)
    ...
    def use_count : _root_.glib.all.guint = struct._2
    def use_count_=(value: _root_.glib.all.guint): Unit = !struct.at2 = value
    def type_infos : Ptr[_root_.glib.all.GSList] = struct._3.asInstanceOf[Ptr[_root_.glib.all.GSList]]
    def type_infos_=(value: Ptr[_root_.glib.all.GSList]): Unit = !struct.at3 = value.asInstanceOf[Ptr[Byte]]
    def interface_infos : Ptr[_root_.glib.all.GSList] = struct._4.asInstanceOf[Ptr[_root_.glib.all.GSList]]
    def interface_infos_=(value: Ptr[_root_.glib.all.GSList]): Unit = !struct.at4 = value.asInstanceOf[Ptr[Byte]]
    def name : Ptr[_root_.glib.all.gchar] = struct._5
    def name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at5 = value
...
object GTypeModuleClass:
  given _tag: Tag[GTypeModuleClass] = Tag.materializeCStruct7Tag[GObjectClass, CFuncPtr1[Ptr[Byte], _root_.glib.all.gboolean], CFuncPtr1[Ptr[Byte], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[GTypeModuleClass] = scala.scalanative.unsafe.alloc[GTypeModuleClass](1)
  def apply(parent_class : GObjectClass, load : CFuncPtr1[Ptr[GTypeModule], _root_.glib.all.gboolean], unload : CFuncPtr1[Ptr[GTypeModule], Unit], reserved1 : CFuncPtr0[Unit], reserved2 : CFuncPtr0[Unit], reserved3 : CFuncPtr0[Unit], reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[GTypeModuleClass] = 
    val ____ptr = apply()
  ...
  extension (struct: GTypeModuleClass)
    ...
    def load : CFuncPtr1[Ptr[GTypeModule], _root_.glib.all.gboolean] = struct._2.asInstanceOf[CFuncPtr1[Ptr[GTypeModule], _root_.glib.all.gboolean]]
    def load_=(value: CFuncPtr1[Ptr[GTypeModule], _root_.glib.all.gboolean]): Unit = !struct.at2 = value.asInstanceOf[CFuncPtr1[Ptr[Byte], _root_.glib.all.gboolean]]
...
object GTypeQuery:
  given _tag: Tag[GTypeQuery] = Tag.materializeCStruct4Tag[GType, Ptr[_root_.glib.all.gchar], _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GTypeQuery] = scala.scalanative.unsafe.alloc[GTypeQuery](1)
  def apply(`type` : GType, type_name : Ptr[_root_.glib.all.gchar], class_size : _root_.glib.all.guint, instance_size : _root_.glib.all.guint)(using Zone): Ptr[GTypeQuery] = 
    val ____ptr = apply()
    (!____ptr).`type` = `type`
  ...
  extension (struct: GTypeQuery)
    ...
    def type_name : Ptr[_root_.glib.all.gchar] = struct._2
    def type_name_=(value: Ptr[_root_.glib.all.gchar]): Unit = !struct.at2 = value
    def class_size : _root_.glib.all.guint = struct._3
    def class_size_=(value: _root_.glib.all.guint): Unit = !struct.at3 = value
    def instance_size : _root_.glib.all.guint = struct._4
...
object GValueArray:
  given _tag: Tag[GValueArray] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, Ptr[GValue], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[GValueArray] = scala.scalanative.unsafe.alloc[GValueArray](1)
  def apply(n_values : _root_.glib.all.guint, values : Ptr[GValue], n_prealloced : _root_.glib.all.guint)(using Zone): Ptr[GValueArray] = 
    val ____ptr = apply()
    (!____ptr).n_values = n_values
    (!____ptr).values = values
  ...
  extension (struct: GValueArray)
    def n_values : _root_.glib.all.guint = struct._1
    def n_values_=(value: _root_.glib.all.guint): Unit = !struct.at1 = value
    def values : Ptr[GValue] = struct._2
    def values_=(value: Ptr[GValue]): Unit = !struct.at2 = value
    def n_prealloced : _root_.glib.all.guint = struct._3
...
object GWeakRef:
  ...
  */
  ...
  object Union0:
    ...
    def apply(p: _root_.glib.all.gpointer)(using Zone): Ptr[Union0] =
      val ___ptr = alloc[Union0](1)
      val un = !___ptr
      un.at(0).asInstanceOf[Ptr[_root_.glib.all.gpointer]].update(0, p)
      ___ptr
    extension (struct: Union0)
      def p : _root_.glib.all.gpointer = !struct.at(0).asInstanceOf[Ptr[_root_.glib.all.gpointer]]
      def p_=(value: _root_.glib.all.gpointer): Unit = !struct.at(0).asInstanceOf[Ptr[_root_.glib.all.gpointer]] = value
...
object _GCClosure:
  given _tag: Tag[_GCClosure] = Tag.materializeCStruct2Tag[GClosure, _root_.glib.all.gpointer]
  def apply()(using Zone): Ptr[_GCClosure] = scala.scalanative.unsafe.alloc[_GCClosure](1)
  def apply(closure : GClosure, callback : _root_.glib.all.gpointer)(using Zone): Ptr[_GCClosure] = 
    val ____ptr = apply()
    (!____ptr).closure = closure
    (!____ptr).callback = callback
    ____ptr
...
object _GClosure:
  given _tag: Tag[_GClosure] = Tag.materializeCStruct13Tag[_root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint, CFuncPtr6[Ptr[Byte], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit], _root_.glib.all.gpointer, Ptr[Byte]]
  def apply()(using Zone): Ptr[_GClosure] = scala.scalanative.unsafe.alloc[_GClosure](1)
  def apply(ref_count : _root_.glib.all.guint, meta_marshal_nouse : _root_.glib.all.guint, n_guards : _root_.glib.all.guint, n_fnotifiers : _root_.glib.all.guint, n_inotifiers : _root_.glib.all.guint, in_inotify : _root_.glib.all.guint, floating : _root_.glib.all.guint, derivative_flag : _root_.glib.all.guint, in_marshal : _root_.glib.all.guint, is_invalid : _root_.glib.all.guint, marshal : CFuncPtr6[Ptr[GClosure], Ptr[GValue], _root_.glib.all.guint, Ptr[GValue], _root_.glib.all.gpointer, _root_.glib.all.gpointer, Unit], data : _root_.glib.all.gpointer, notifiers : Ptr[GClosureNotifyData])(using Zone): Ptr[_GClosure] = 
    val ____ptr = apply()
    (!____ptr).ref_count = ref_count
    (!____ptr).meta_marshal_nouse = meta_marshal_nouse
    (!____ptr).n_guards = n_guards
...
object _GClosureNotifyData:
  given _tag: Tag[_GClosureNotifyData] = Tag.materializeCStruct2Tag[_root_.glib.all.gpointer, Ptr[Byte]]
  def apply()(using Zone): Ptr[_GClosureNotifyData] = scala.scalanative.unsafe.alloc[_GClosureNotifyData](1)
  def apply(data : _root_.glib.all.gpointer, _notify : GClosureNotify)(using Zone): Ptr[_GClosureNotifyData] = 
    val ____ptr = apply()
    (!____ptr).data = data
    (!____ptr)._notify = _notify
    ____ptr
...
object _GEnumClass:
  given _tag: Tag[_GEnumClass] = Tag.materializeCStruct5Tag[GTypeClass, _root_.glib.all.gint, _root_.glib.all.gint, _root_.glib.all.guint, Ptr[GEnumValue]]
  def apply()(using Zone): Ptr[_GEnumClass] = scala.scalanative.unsafe.alloc[_GEnumClass](1)
  def apply(g_type_class : GTypeClass, minimum : _root_.glib.all.gint, maximum : _root_.glib.all.gint, n_values : _root_.glib.all.guint, values : Ptr[GEnumValue])(using Zone): Ptr[_GEnumClass] = 
    val ____ptr = apply()
    (!____ptr).g_type_class = g_type_class
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GEnumValue:
  given _tag: Tag[_GEnumValue] = Tag.materializeCStruct3Tag[_root_.glib.all.gint, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[_GEnumValue] = scala.scalanative.unsafe.alloc[_GEnumValue](1)
  def apply(value : _root_.glib.all.gint, value_name : Ptr[_root_.glib.all.gchar], value_nick : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[_GEnumValue] = 
    val ____ptr = apply()
    (!____ptr).value = value
    (!____ptr).value_name = value_name
    (!____ptr).value_nick = value_nick
...
object _GFlagsClass:
  given _tag: Tag[_GFlagsClass] = Tag.materializeCStruct4Tag[GTypeClass, _root_.glib.all.guint, _root_.glib.all.guint, Ptr[GFlagsValue]]
  def apply()(using Zone): Ptr[_GFlagsClass] = scala.scalanative.unsafe.alloc[_GFlagsClass](1)
  def apply(g_type_class : GTypeClass, mask : _root_.glib.all.guint, n_values : _root_.glib.all.guint, values : Ptr[GFlagsValue])(using Zone): Ptr[_GFlagsClass] = 
    val ____ptr = apply()
    (!____ptr).g_type_class = g_type_class
    (!____ptr).mask = mask
    (!____ptr).n_values = n_values
...
object _GFlagsValue:
  given _tag: Tag[_GFlagsValue] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[_GFlagsValue] = scala.scalanative.unsafe.alloc[_GFlagsValue](1)
  def apply(value : _root_.glib.all.guint, value_name : Ptr[_root_.glib.all.gchar], value_nick : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[_GFlagsValue] = 
    val ____ptr = apply()
    (!____ptr).value = value
    (!____ptr).value_name = value_name
    (!____ptr).value_nick = value_nick
...
object _GInterfaceInfo:
  given _tag: Tag[_GInterfaceInfo] = Tag.materializeCStruct3Tag[GInterfaceInitFunc, GInterfaceFinalizeFunc, _root_.glib.all.gpointer]
  def apply()(using Zone): Ptr[_GInterfaceInfo] = scala.scalanative.unsafe.alloc[_GInterfaceInfo](1)
  def apply(interface_init : GInterfaceInitFunc, interface_finalize : GInterfaceFinalizeFunc, interface_data : _root_.glib.all.gpointer)(using Zone): Ptr[_GInterfaceInfo] = 
    val ____ptr = apply()
    (!____ptr).interface_init = interface_init
    (!____ptr).interface_finalize = interface_finalize
    (!____ptr).interface_data = interface_data
...
object _GObject:
  given _tag: Tag[_GObject] = Tag.materializeCStruct3Tag[GTypeInstance, _root_.glib.all.guint, Ptr[_root_.glib.all.GData]]
  def apply()(using Zone): Ptr[_GObject] = scala.scalanative.unsafe.alloc[_GObject](1)
  def apply(g_type_instance : GTypeInstance, ref_count : _root_.glib.all.guint, qdata : Ptr[_root_.glib.all.GData])(using Zone): Ptr[_GObject] = 
    val ____ptr = apply()
    (!____ptr).g_type_instance = g_type_instance
    (!____ptr).ref_count = ref_count
    (!____ptr).qdata = qdata
...
object _GParamSpec:
  given _tag: Tag[_GParamSpec] = Tag.materializeCStruct10Tag[GTypeInstance, Ptr[_root_.glib.all.gchar], GParamFlags, GType, GType, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.GData], _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GParamSpec] = scala.scalanative.unsafe.alloc[_GParamSpec](1)
  def apply(g_type_instance : GTypeInstance, name : Ptr[_root_.glib.all.gchar], flags : GParamFlags, value_type : GType, owner_type : GType, _nick : Ptr[_root_.glib.all.gchar], _blurb : Ptr[_root_.glib.all.gchar], qdata : Ptr[_root_.glib.all.GData], ref_count : _root_.glib.all.guint, param_id : _root_.glib.all.guint)(using Zone): Ptr[_GParamSpec] = 
    val ____ptr = apply()
    (!____ptr).g_type_instance = g_type_instance
    (!____ptr).name = name
    (!____ptr).flags = flags
...
object _GParamSpecBoolean:
  given _tag: Tag[_GParamSpecBoolean] = Tag.materializeCStruct2Tag[GParamSpec, _root_.glib.all.gboolean]
  def apply()(using Zone): Ptr[_GParamSpecBoolean] = scala.scalanative.unsafe.alloc[_GParamSpecBoolean](1)
  def apply(parent_instance : GParamSpec, default_value : _root_.glib.all.gboolean)(using Zone): Ptr[_GParamSpecBoolean] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).default_value = default_value
    ____ptr
...
object _GParamSpecChar:
  given _tag: Tag[_GParamSpecChar] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint8, _root_.glib.all.gint8, _root_.glib.all.gint8]
  def apply()(using Zone): Ptr[_GParamSpecChar] = scala.scalanative.unsafe.alloc[_GParamSpecChar](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint8, maximum : _root_.glib.all.gint8, default_value : _root_.glib.all.gint8)(using Zone): Ptr[_GParamSpecChar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecDouble:
  given _tag: Tag[_GParamSpecDouble] = Tag.materializeCStruct5Tag[GParamSpec, _root_.glib.all.gdouble, _root_.glib.all.gdouble, _root_.glib.all.gdouble, _root_.glib.all.gdouble]
  def apply()(using Zone): Ptr[_GParamSpecDouble] = scala.scalanative.unsafe.alloc[_GParamSpecDouble](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gdouble, maximum : _root_.glib.all.gdouble, default_value : _root_.glib.all.gdouble, epsilon : _root_.glib.all.gdouble)(using Zone): Ptr[_GParamSpecDouble] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecEnum:
  given _tag: Tag[_GParamSpecEnum] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GEnumClass], _root_.glib.all.gint]
  def apply()(using Zone): Ptr[_GParamSpecEnum] = scala.scalanative.unsafe.alloc[_GParamSpecEnum](1)
  def apply(parent_instance : GParamSpec, enum_class : Ptr[GEnumClass], default_value : _root_.glib.all.gint)(using Zone): Ptr[_GParamSpecEnum] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).enum_class = enum_class
    (!____ptr).default_value = default_value
...
object _GParamSpecFlags:
  given _tag: Tag[_GParamSpecFlags] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GFlagsClass], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GParamSpecFlags] = scala.scalanative.unsafe.alloc[_GParamSpecFlags](1)
  def apply(parent_instance : GParamSpec, flags_class : Ptr[GFlagsClass], default_value : _root_.glib.all.guint)(using Zone): Ptr[_GParamSpecFlags] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).flags_class = flags_class
    (!____ptr).default_value = default_value
...
object _GParamSpecFloat:
  given _tag: Tag[_GParamSpecFloat] = Tag.materializeCStruct5Tag[GParamSpec, _root_.glib.all.gfloat, _root_.glib.all.gfloat, _root_.glib.all.gfloat, _root_.glib.all.gfloat]
  def apply()(using Zone): Ptr[_GParamSpecFloat] = scala.scalanative.unsafe.alloc[_GParamSpecFloat](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gfloat, maximum : _root_.glib.all.gfloat, default_value : _root_.glib.all.gfloat, epsilon : _root_.glib.all.gfloat)(using Zone): Ptr[_GParamSpecFloat] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecInt:
  given _tag: Tag[_GParamSpecInt] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint, _root_.glib.all.gint, _root_.glib.all.gint]
  def apply()(using Zone): Ptr[_GParamSpecInt] = scala.scalanative.unsafe.alloc[_GParamSpecInt](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint, maximum : _root_.glib.all.gint, default_value : _root_.glib.all.gint)(using Zone): Ptr[_GParamSpecInt] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecInt64:
  given _tag: Tag[_GParamSpecInt64] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gint64, _root_.glib.all.gint64, _root_.glib.all.gint64]
  def apply()(using Zone): Ptr[_GParamSpecInt64] = scala.scalanative.unsafe.alloc[_GParamSpecInt64](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gint64, maximum : _root_.glib.all.gint64, default_value : _root_.glib.all.gint64)(using Zone): Ptr[_GParamSpecInt64] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecLong:
  given _tag: Tag[_GParamSpecLong] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.glong, _root_.glib.all.glong, _root_.glib.all.glong]
  def apply()(using Zone): Ptr[_GParamSpecLong] = scala.scalanative.unsafe.alloc[_GParamSpecLong](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.glong, maximum : _root_.glib.all.glong, default_value : _root_.glib.all.glong)(using Zone): Ptr[_GParamSpecLong] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecString:
  given _tag: Tag[_GParamSpecString] = Tag.materializeCStruct7Tag[GParamSpec, Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], Ptr[_root_.glib.all.gchar], _root_.glib.all.gchar, _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GParamSpecString] = scala.scalanative.unsafe.alloc[_GParamSpecString](1)
  def apply(parent_instance : GParamSpec, default_value : Ptr[_root_.glib.all.gchar], cset_first : Ptr[_root_.glib.all.gchar], cset_nth : Ptr[_root_.glib.all.gchar], substitutor : _root_.glib.all.gchar, null_fold_if_empty : _root_.glib.all.guint, ensure_non_null : _root_.glib.all.guint)(using Zone): Ptr[_GParamSpecString] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).default_value = default_value
    (!____ptr).cset_first = cset_first
...
object _GParamSpecTypeInfo:
  ...
  def apply(instance_size : _root_.glib.all.guint16, n_preallocs : _root_.glib.all.guint16, instance_init : CFuncPtr1[Ptr[GParamSpec], Unit], value_type : GType, finalize : CFuncPtr1[Ptr[GParamSpec], Unit], value_set_default : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], Unit], value_validate : CFuncPtr2[Ptr[GParamSpec], Ptr[GValue], _root_.glib.all.gboolean], values_cmp : CFuncPtr3[Ptr[GParamSpec], Ptr[GValue], Ptr[GValue], _root_.glib.all.gint])(using Zone): Ptr[_GParamSpecTypeInfo] = 
    val ____ptr = apply()
    (!____ptr).instance_size = instance_size
    (!____ptr).n_preallocs = n_preallocs
    (!____ptr).instance_init = instance_init
...
object _GParamSpecUChar:
  given _tag: Tag[_GParamSpecUChar] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint8, _root_.glib.all.guint8, _root_.glib.all.guint8]
  def apply()(using Zone): Ptr[_GParamSpecUChar] = scala.scalanative.unsafe.alloc[_GParamSpecUChar](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint8, maximum : _root_.glib.all.guint8, default_value : _root_.glib.all.guint8)(using Zone): Ptr[_GParamSpecUChar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecUInt:
  given _tag: Tag[_GParamSpecUInt] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint, _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GParamSpecUInt] = scala.scalanative.unsafe.alloc[_GParamSpecUInt](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint, maximum : _root_.glib.all.guint, default_value : _root_.glib.all.guint)(using Zone): Ptr[_GParamSpecUInt] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecUInt64:
  given _tag: Tag[_GParamSpecUInt64] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.guint64, _root_.glib.all.guint64, _root_.glib.all.guint64]
  def apply()(using Zone): Ptr[_GParamSpecUInt64] = scala.scalanative.unsafe.alloc[_GParamSpecUInt64](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.guint64, maximum : _root_.glib.all.guint64, default_value : _root_.glib.all.guint64)(using Zone): Ptr[_GParamSpecUInt64] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecULong:
  given _tag: Tag[_GParamSpecULong] = Tag.materializeCStruct4Tag[GParamSpec, _root_.glib.all.gulong, _root_.glib.all.gulong, _root_.glib.all.gulong]
  def apply()(using Zone): Ptr[_GParamSpecULong] = scala.scalanative.unsafe.alloc[_GParamSpecULong](1)
  def apply(parent_instance : GParamSpec, minimum : _root_.glib.all.gulong, maximum : _root_.glib.all.gulong, default_value : _root_.glib.all.gulong)(using Zone): Ptr[_GParamSpecULong] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).minimum = minimum
    (!____ptr).maximum = maximum
...
object _GParamSpecUnichar:
  given _tag: Tag[_GParamSpecUnichar] = Tag.materializeCStruct2Tag[GParamSpec, _root_.glib.all.gunichar]
  def apply()(using Zone): Ptr[_GParamSpecUnichar] = scala.scalanative.unsafe.alloc[_GParamSpecUnichar](1)
  def apply(parent_instance : GParamSpec, default_value : _root_.glib.all.gunichar)(using Zone): Ptr[_GParamSpecUnichar] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).default_value = default_value
    ____ptr
...
object _GParamSpecValueArray:
  given _tag: Tag[_GParamSpecValueArray] = Tag.materializeCStruct3Tag[GParamSpec, Ptr[GParamSpec], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GParamSpecValueArray] = scala.scalanative.unsafe.alloc[_GParamSpecValueArray](1)
  def apply(parent_instance : GParamSpec, element_spec : Ptr[GParamSpec], fixed_n_elements : _root_.glib.all.guint)(using Zone): Ptr[_GParamSpecValueArray] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).element_spec = element_spec
    (!____ptr).fixed_n_elements = fixed_n_elements
...
object _GParamSpecVariant:
  given _tag: Tag[_GParamSpecVariant] = Tag.materializeCStruct4Tag[GParamSpec, Ptr[_root_.glib.all.GVariantType], Ptr[_root_.glib.all.GVariant], CArray[_root_.glib.all.gpointer, Nat._4]]
  def apply()(using Zone): Ptr[_GParamSpecVariant] = scala.scalanative.unsafe.alloc[_GParamSpecVariant](1)
  def apply(parent_instance : GParamSpec, `type` : Ptr[_root_.glib.all.GVariantType], default_value : Ptr[_root_.glib.all.GVariant], padding : CArray[_root_.glib.all.gpointer, Nat._4])(using Zone): Ptr[_GParamSpecVariant] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).`type` = `type`
    (!____ptr).default_value = default_value
...
object _GParameter:
  given _tag: Tag[_GParameter] = Tag.materializeCStruct2Tag[Ptr[_root_.glib.all.gchar], GValue]
  def apply()(using Zone): Ptr[_GParameter] = scala.scalanative.unsafe.alloc[_GParameter](1)
  def apply(name : Ptr[_root_.glib.all.gchar], value : GValue)(using Zone): Ptr[_GParameter] = 
    val ____ptr = apply()
    (!____ptr).name = name
    (!____ptr).value = value
    ____ptr
...
object _GSignalInvocationHint:
  given _tag: Tag[_GSignalInvocationHint] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, _root_.glib.all.GQuark, GSignalFlags]
  def apply()(using Zone): Ptr[_GSignalInvocationHint] = scala.scalanative.unsafe.alloc[_GSignalInvocationHint](1)
  def apply(signal_id : _root_.glib.all.guint, detail : _root_.glib.all.GQuark, run_type : GSignalFlags)(using Zone): Ptr[_GSignalInvocationHint] = 
    val ____ptr = apply()
    (!____ptr).signal_id = signal_id
    (!____ptr).detail = detail
    (!____ptr).run_type = run_type
...
object _GSignalQuery:
  given _tag: Tag[_GSignalQuery] = Tag.materializeCStruct7Tag[_root_.glib.all.guint, Ptr[_root_.glib.all.gchar], GType, GSignalFlags, GType, _root_.glib.all.guint, Ptr[GType]]
  def apply()(using Zone): Ptr[_GSignalQuery] = scala.scalanative.unsafe.alloc[_GSignalQuery](1)
  def apply(signal_id : _root_.glib.all.guint, signal_name : Ptr[_root_.glib.all.gchar], itype : GType, signal_flags : GSignalFlags, return_type : GType, n_params : _root_.glib.all.guint, param_types : Ptr[GType])(using Zone): Ptr[_GSignalQuery] = 
    val ____ptr = apply()
    (!____ptr).signal_id = signal_id
    (!____ptr).signal_name = signal_name
    (!____ptr).itype = itype
...
object _GTypeInfo:
  given _tag: Tag[_GTypeInfo] = Tag.materializeCStruct10Tag[_root_.glib.all.guint16, GBaseInitFunc, GBaseFinalizeFunc, GClassInitFunc, GClassFinalizeFunc, _root_.glib.all.gconstpointer, _root_.glib.all.guint16, _root_.glib.all.guint16, GInstanceInitFunc, Ptr[GTypeValueTable]]
...
object _GTypeModule:
  given _tag: Tag[_GTypeModule] = Tag.materializeCStruct5Tag[GObject, _root_.glib.all.guint, Ptr[Byte], Ptr[Byte], Ptr[_root_.glib.all.gchar]]
  def apply()(using Zone): Ptr[_GTypeModule] = scala.scalanative.unsafe.alloc[_GTypeModule](1)
  def apply(parent_instance : GObject, use_count : _root_.glib.all.guint, type_infos : Ptr[_root_.glib.all.GSList], interface_infos : Ptr[_root_.glib.all.GSList], name : Ptr[_root_.glib.all.gchar])(using Zone): Ptr[_GTypeModule] = 
    val ____ptr = apply()
    (!____ptr).parent_instance = parent_instance
    (!____ptr).use_count = use_count
    (!____ptr).type_infos = type_infos
...
object _GTypeModuleClass:
  given _tag: Tag[_GTypeModuleClass] = Tag.materializeCStruct7Tag[GObjectClass, CFuncPtr1[Ptr[Byte], _root_.glib.all.gboolean], CFuncPtr1[Ptr[Byte], Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit], CFuncPtr0[Unit]]
  def apply()(using Zone): Ptr[_GTypeModuleClass] = scala.scalanative.unsafe.alloc[_GTypeModuleClass](1)
  def apply(parent_class : GObjectClass, load : CFuncPtr1[Ptr[GTypeModule], _root_.glib.all.gboolean], unload : CFuncPtr1[Ptr[GTypeModule], Unit], reserved1 : CFuncPtr0[Unit], reserved2 : CFuncPtr0[Unit], reserved3 : CFuncPtr0[Unit], reserved4 : CFuncPtr0[Unit])(using Zone): Ptr[_GTypeModuleClass] = 
    val ____ptr = apply()
    (!____ptr).parent_class = parent_class
    (!____ptr).load = load
    (!____ptr).unload = unload
...
object _GTypeQuery:
  given _tag: Tag[_GTypeQuery] = Tag.materializeCStruct4Tag[GType, Ptr[_root_.glib.all.gchar], _root_.glib.all.guint, _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GTypeQuery] = scala.scalanative.unsafe.alloc[_GTypeQuery](1)
  def apply(`type` : GType, type_name : Ptr[_root_.glib.all.gchar], class_size : _root_.glib.all.guint, instance_size : _root_.glib.all.guint)(using Zone): Ptr[_GTypeQuery] = 
    val ____ptr = apply()
    (!____ptr).`type` = `type`
    (!____ptr).type_name = type_name
    (!____ptr).class_size = class_size
...
object _GValueArray:
  given _tag: Tag[_GValueArray] = Tag.materializeCStruct3Tag[_root_.glib.all.guint, Ptr[GValue], _root_.glib.all.guint]
  def apply()(using Zone): Ptr[_GValueArray] = scala.scalanative.unsafe.alloc[_GValueArray](1)
  def apply(n_values : _root_.glib.all.guint, values : Ptr[GValue], n_prealloced : _root_.glib.all.guint)(using Zone): Ptr[_GValueArray] = 
    val ____ptr = apply()
    (!____ptr).n_values = n_values
    (!____ptr).values = values
    (!____ptr).n_prealloced = n_prealloced
