...
private[gobject] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gobject.h
  */
  def g_object_connect(`object` : _root_.glib.all.gpointer, signal_spec : Ptr[_root_.glib.all.gchar]): _root_.glib.all.gpointer = extern

  /**
   * [bindgen] header: /usr/include/glib-2.0/gobject/gobject.h
  */
  def g_object_disconnect(`object` : _root_.glib.all.gpointer, signal_spec : Ptr[_root_.glib.all.gchar]): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gobject.h
  */
  def g_object_get(`object` : _root_.glib.all.gpointer, first_property_name : Ptr[_root_.glib.all.gchar]): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gobject.h
  */
  def g_object_new(object_type : GType, first_property_name : Ptr[_root_.glib.all.gchar]): _root_.glib.all.gpointer = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gobject.h
  */
  def g_object_set(`object` : _root_.glib.all.gpointer, first_property_name : Ptr[_root_.glib.all.gchar]): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gsignal.h
  */
  def g_signal_chain_from_overridden_handler(instance : _root_.glib.all.gpointer): Unit = extern
  ...
  */
   ...
   * [bindgen] header: /usr/include/glib-2.0/gobject/gsignal.h
  */
  def g_signal_emit(instance : _root_.glib.all.gpointer, signal_id : _root_.glib.all.guint, detail : _root_.glib.all.GQuark): Unit = extern

  /**
   * [bindgen] header: /usr/include/glib-2.0/gobject/gsignal.h
  */
  def g_signal_emit_by_name(instance : _root_.glib.all.gpointer, detailed_signal : Ptr[_root_.glib.all.gchar]): Unit = extern
