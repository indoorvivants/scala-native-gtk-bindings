...
class Object(raw: Ptr[GObject]):
  ...
  def getv(n_properties: UInt, names: Ptr[CString], values: Ptr[GValue])(using
      Zone
  ): Unit = g_object_getv(
    this.raw.asInstanceOf,
    guint(n_properties),
  ...
  )(using Zone): Boolean = g_object_replace_data(
    this.raw.asInstanceOf,
    __sn_extract_string(key).asInstanceOf[Ptr[gchar]],
    gpointer(oldval),
    gpointer(newval),
  ...
  def replaceQdata(
      ...
      destroy: GDestroyNotify,
      old_destroy: Ptr[GDestroyNotify]
  ): Boolean = g_object_replace_qdata(
    this.raw.asInstanceOf,
    quark,
    gpointer(oldval),
    gpointer(newval),
  ...
  def setv(n_properties: UInt, names: Ptr[CString], values: Ptr[GValue])(using
      Zone
  ): Unit = g_object_setv(
    this.raw.asInstanceOf,
    guint(n_properties),
