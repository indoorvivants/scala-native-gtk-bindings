...
private[libgdkpixbuf] object extern_functions:
  /**
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-enum-types.h
  */
  ...
  */
   ...
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-core.h
  */
  def gdk_pixbuf_save(pixbuf : Ptr[GdkPixbuf], filename : CString, `type` : CString, error : Ptr[Ptr[_root_.glib.all.GError]], rest: Any*): _root_.glib.all.gboolean = extern

  /**
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-core.h
  */
  def gdk_pixbuf_save_to_buffer(pixbuf : Ptr[GdkPixbuf], buffer : Ptr[Ptr[_root_.glib.all.gchar]], buffer_size : Ptr[_root_.glib.all.gsize], `type` : CString, error : Ptr[Ptr[_root_.glib.all.GError]], rest: Any*): _root_.glib.all.gboolean = extern
  ...
  */
   ...
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-core.h
  */
  def gdk_pixbuf_save_to_callback(pixbuf : Ptr[GdkPixbuf], save_func : GdkPixbufSaveFunc, user_data : _root_.glib.all.gpointer, `type` : CString, error : Ptr[Ptr[_root_.glib.all.GError]], rest: Any*): _root_.glib.all.gboolean = extern
  ...
  */
   ...
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-core.h
  */
  def gdk_pixbuf_save_to_stream(pixbuf : Ptr[GdkPixbuf], stream : Ptr[_root_.gio.all.GOutputStream], `type` : CString, cancellable : Ptr[_root_.gio.all.GCancellable], error : Ptr[Ptr[_root_.glib.all.GError]], rest: Any*): _root_.glib.all.gboolean = extern

  /**
   * [bindgen] header: /opt/homebrew/Cellar/gdk-pixbuf/2.42.10_1/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf-core.h
  */
  def gdk_pixbuf_save_to_stream_async(pixbuf : Ptr[GdkPixbuf], stream : Ptr[_root_.gio.all.GOutputStream], `type` : Ptr[_root_.glib.all.gchar], cancellable : Ptr[_root_.gio.all.GCancellable], callback : _root_.gio.all.GAsyncReadyCallback, user_data : _root_.glib.all.gpointer, rest: Any*): Unit = extern
